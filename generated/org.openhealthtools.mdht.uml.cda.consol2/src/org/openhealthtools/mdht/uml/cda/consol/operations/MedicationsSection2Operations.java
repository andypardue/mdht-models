...
public class MedicationsSection2Operations extends MedicationsSectionEntriesOptional2Operations {
	...
	public static boolean validateMedicationsSection2NullFlavor(MedicationsSection2 medicationsSection2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_MEDICATIONS_SECTION2_NULL_FLAVOR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(medicationsSection2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
	...
	public static boolean validateMedicationsSection2Title(MedicationsSection2 medicationsSection2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_MEDICATIONS_SECTION2_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(medicationsSection2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateMedicationsSection2Text(MedicationsSection2 medicationsSection2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_MEDICATIONS_SECTION2_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(medicationsSection2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	/**
	 * The cached OCL expression body for the '{@link #validateMedicationsSection2Entry1198(MedicationsSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Medications Section2 Entry1198</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateMedicationsSection2Entry1198(MedicationsSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_MEDICATIONS_SECTION2_ENTRY1198__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.nullFlavor <> vocab::NullFlavor::NI implies entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(cda::Entry))";

	/**
	 * The cached OCL invariant for the '{@link #validateMedicationsSection2Entry1198(MedicationsSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Medications Section2 Entry1198</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateMedicationsSection2Entry1198(MedicationsSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Constraint VALIDATE_MEDICATIONS_SECTION2_ENTRY1198__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validateMedicationsSection2Entry1198(MedicationsSection2 medicationsSection2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_MEDICATIONS_SECTION2_ENTRY1198__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.MEDICATIONS_SECTION2);
			try {
				VALIDATE_MEDICATIONS_SECTION2_ENTRY1198__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_MEDICATIONS_SECTION2_ENTRY1198__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_MEDICATIONS_SECTION2_ENTRY1198__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(medicationsSection2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.MEDICATIONS_SECTION2__MEDICATIONS_SECTION2_ENTRY1198,
						 ConsolPlugin.INSTANCE.getString("MedicationsSection2MedicationsSection2Entry1198"),
						 new Object [] { medicationsSection2 }));
			}
	...
	/**
	 * The cached OCL expression body for the '{@link #validateMedicationsSection2MedicationActivity2EntryMedicationActivity21199(MedicationsSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Medications Section2 Medication Activity2 Entry Medication Activity21199</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateMedicationsSection2MedicationActivity2EntryMedicationActivity21199(MedicationsSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The cached OCL invariant for the '{@link #validateMedicationsSection2MedicationActivity2EntryMedicationActivity21199(MedicationsSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Medications Section2 Medication Activity2 Entry Medication Activity21199</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateMedicationsSection2MedicationActivity2EntryMedicationActivity21199(MedicationsSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Query<?, ?, ?> VALIDATE_MEDICATIONS_SECTION2_MEDICATION_ACTIVITY2_ENTRY_MEDICATION_ACTIVITY21199__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY;
	...
	public static  boolean validateMedicationsSection2MedicationActivity2EntryMedicationActivity21199(MedicationsSection2 medicationsSection2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_MEDICATIONS_SECTION2_MEDICATION_ACTIVITY2_ENTRY_MEDICATION_ACTIVITY21199__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.MEDICATIONS_SECTION2);
			try {
				OCLExpression<EClassifier> oclExpression = helper.createQuery(VALIDATE_MEDICATIONS_SECTION2_MEDICATION_ACTIVITY2_ENTRY_MEDICATION_ACTIVITY21199__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
				VALIDATE_MEDICATIONS_SECTION2_MEDICATION_ACTIVITY2_ENTRY_MEDICATION_ACTIVITY21199__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = EOCL_ENV.createQuery(oclExpression);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		Object oclResult = VALIDATE_MEDICATIONS_SECTION2_MEDICATION_ACTIVITY2_ENTRY_MEDICATION_ACTIVITY21199__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY.evaluate(medicationsSection2);		
			...
			if (diagnostics != null) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.MEDICATIONS_SECTION2__MEDICATIONS_SECTION2_MEDICATION_ACTIVITY2_ENTRY_MEDICATION_ACTIVITY21199,
						 ConsolPlugin.INSTANCE.getString("MedicationsSection2MedicationsSection2MedicationActivity2EntryMedicationActivity21199"),
						 new Object [] { eObject }));
				}
	...
	public static boolean validateMedicationsSectionEntriesOptionalTemplateId(MedicationsSection2 medicationsSection2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_MEDICATIONS_SECTION_ENTRIES_OPTIONAL_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(medicationsSection2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateMedicationsSectionEntriesOptionalCodeP(MedicationsSection2 medicationsSection2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_MEDICATIONS_SECTION_ENTRIES_OPTIONAL_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(medicationsSection2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
...
"value.code = '10160-0' and value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	public static boolean validateMedicationsSectionEntriesOptionalCode(MedicationsSection2 medicationsSection2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_MEDICATIONS_SECTION_ENTRIES_OPTIONAL_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(medicationsSection2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
