 ...
 *   <li>{@link org.openhealthtools.mdht.uml.cda.consol.CoverageActivity2#validateCoverageActivity2EntryRelationship898(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Coverage Activity2 Entry Relationship898</em>}</li>
 ...
 *   <li>{@link org.openhealthtools.mdht.uml.cda.consol.CoverageActivity2#validateCoverageActivity2PolicyActivity2EntryRelationshipPolicyActivity2899(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Coverage Activity2 Policy Activity2 Entry Relationship Policy Activity2899</em>}</li>
...
public class CoverageActivity2Operations extends CoverageActivityOperations {
	...
	public static boolean validateCoverageActivityCodeP(CoverageActivity2 coverageActivity2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_COVERAGE_ACTIVITY_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(coverageActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateCoverageActivity2EntryRelationship(CoverageActivity2 coverageActivity2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_COVERAGE_ACTIVITY2_ENTRY_RELATIONSHIP__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(coverageActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  boolean validateCoverageActivity2EntryRelationship898(CoverageActivity2 coverageActivity2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_COVERAGE_ACTIVITY2_ENTRY_RELATIONSHIP898__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.COVERAGE_ACTIVITY2);
			try {
				VALIDATE_COVERAGE_ACTIVITY2_ENTRY_RELATIONSHIP898__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_COVERAGE_ACTIVITY2_ENTRY_RELATIONSHIP898__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_COVERAGE_ACTIVITY2_ENTRY_RELATIONSHIP898__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(coverageActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.COVERAGE_ACTIVITY2__COVERAGE_ACTIVITY2_ENTRY_RELATIONSHIP898,
						 ConsolPlugin.INSTANCE.getString("CoverageActivity2CoverageActivity2EntryRelationship898"),
						 new Object [] { coverageActivity2 }));
			}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static  boolean validateCoverageActivity2PolicyActivity2EntryRelationshipPolicyActivity2899(CoverageActivity2 coverageActivity2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_COVERAGE_ACTIVITY2_POLICY_ACTIVITY2_ENTRY_RELATIONSHIP_POLICY_ACTIVITY2899__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.COVERAGE_ACTIVITY2);
			try {
				OCLExpression<EClassifier> oclExpression = helper.createQuery(VALIDATE_COVERAGE_ACTIVITY2_POLICY_ACTIVITY2_ENTRY_RELATIONSHIP_POLICY_ACTIVITY2899__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
				VALIDATE_COVERAGE_ACTIVITY2_POLICY_ACTIVITY2_ENTRY_RELATIONSHIP_POLICY_ACTIVITY2899__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = EOCL_ENV.createQuery(oclExpression);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		Object oclResult = VALIDATE_COVERAGE_ACTIVITY2_POLICY_ACTIVITY2_ENTRY_RELATIONSHIP_POLICY_ACTIVITY2899__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY.evaluate(coverageActivity2);		
		if (oclResult != null && oclResult instanceof Collection) {
			Collection<? extends EObject> oclResultSet = (Collection<? extends EObject>) oclResult;
			...
			if (diagnostics != null) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.COVERAGE_ACTIVITY2__COVERAGE_ACTIVITY2_POLICY_ACTIVITY2_ENTRY_RELATIONSHIP_POLICY_ACTIVITY2899,
						 ConsolPlugin.INSTANCE.getString("CoverageActivity2CoverageActivity2PolicyActivity2EntryRelationshipPolicyActivity2899"),
						 new Object [] { eObject }));
				}
	...
	public static boolean validateCoverageActivityCoverageActivityRelationshipSequenceNumber(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_COVERAGE_ACTIVITY_COVERAGE_ACTIVITY_RELATIONSHIP_SEQUENCE_NUMBER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(coverageActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
	...
	/**
	 * The cached OCL expression body for the '{@link #validateCoverageActivity2EntryRelationship898(CoverageActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Coverage Activity2 Entry Relationship898</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateCoverageActivity2EntryRelationship898(CoverageActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_COVERAGE_ACTIVITY2_ENTRY_RELATIONSHIP898__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entryRelationship->one(entryRelationship : cda::EntryRelationship | not entryRelationship.oclIsUndefined() and entryRelationship.oclIsKindOf(cda::EntryRelationship))";

	/**
	 * The cached OCL invariant for the '{@link #validateCoverageActivity2EntryRelationship898(CoverageActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Coverage Activity2 Entry Relationship898</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateCoverageActivity2EntryRelationship898(CoverageActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Constraint VALIDATE_COVERAGE_ACTIVITY2_ENTRY_RELATIONSHIP898__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	/**
	 * The cached OCL expression body for the '{@link #validateCoverageActivity2PolicyActivity2EntryRelationshipPolicyActivity2899(CoverageActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Coverage Activity2 Policy Activity2 Entry Relationship Policy Activity2899</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateCoverageActivity2PolicyActivity2EntryRelationshipPolicyActivity2899(CoverageActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_COVERAGE_ACTIVITY2_POLICY_ACTIVITY2_ENTRY_RELATIONSHIP_POLICY_ACTIVITY2899__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entryRelationship->excluding(null)->reject(act->exists(act : cda::Act | not act.oclIsUndefined() and act.oclIsKindOf(consol::PolicyActivity2)))";

	/**
	 * The cached OCL invariant for the '{@link #validateCoverageActivity2PolicyActivity2EntryRelationshipPolicyActivity2899(CoverageActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Coverage Activity2 Policy Activity2 Entry Relationship Policy Activity2899</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateCoverageActivity2PolicyActivity2EntryRelationshipPolicyActivity2899(CoverageActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Query<?, ?, ?> VALIDATE_COVERAGE_ACTIVITY2_POLICY_ACTIVITY2_ENTRY_RELATIONSHIP_POLICY_ACTIVITY2899__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY;
	...
	public static boolean validateCoverageActivityTemplateId(CoverageActivity2 coverageActivity2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_COVERAGE_ACTIVITY_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(coverageActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
...
"value.code = '48768-6' and value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	public static boolean validateCoverageActivityCode(CoverageActivity2 coverageActivity2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_COVERAGE_ACTIVITY_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(coverageActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
