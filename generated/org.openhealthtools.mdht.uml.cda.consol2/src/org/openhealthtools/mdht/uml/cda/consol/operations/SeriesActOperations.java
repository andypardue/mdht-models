...
"value.code = '113015' and value.codeSystem = '1.2.840.10008.2.16.4')";
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_SERIES_ACT_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.id->isEmpty() or self.id->exists(element | element.isNullFlavorUndefined())) implies (self.id->size() >= 1)";
	...
	/**
	 * The cached OCL expression body for the '{@link #validateSeriesActEntryRelationship538(SeriesAct, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Series Act Entry Relationship538</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateSeriesActEntryRelationship538(SeriesAct, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_SERIES_ACT_ENTRY_RELATIONSHIP538__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entryRelationship->one(entryRelationship : cda::EntryRelationship | not entryRelationship.oclIsUndefined() and entryRelationship.oclIsKindOf(cda::EntryRelationship))";

	/**
	 * The cached OCL invariant for the '{@link #validateSeriesActEntryRelationship538(SeriesAct, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Series Act Entry Relationship538</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateSeriesActEntryRelationship538(SeriesAct, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Constraint VALIDATE_SERIES_ACT_ENTRY_RELATIONSHIP538__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validateSeriesActEntryRelationship538(SeriesAct seriesAct, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_SERIES_ACT_ENTRY_RELATIONSHIP538__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.SERIES_ACT);
			try {
				VALIDATE_SERIES_ACT_ENTRY_RELATIONSHIP538__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_SERIES_ACT_ENTRY_RELATIONSHIP538__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_SERIES_ACT_ENTRY_RELATIONSHIP538__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(seriesAct)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.SERIES_ACT__SERIES_ACT_ENTRY_RELATIONSHIP538,
						 ConsolPlugin.INSTANCE.getString("SeriesActSeriesActEntryRelationship538"),
						 new Object [] { seriesAct }));
			}
	...
	/**
	 * The cached OCL expression body for the '{@link #validateSeriesActSOPInstanceObservationEntryRelationshipSOPInstanceObservation539(SeriesAct, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Series Act SOP Instance Observation Entry Relationship SOP Instance Observation539</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateSeriesActSOPInstanceObservationEntryRelationshipSOPInstanceObservation539(SeriesAct, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The cached OCL invariant for the '{@link #validateSeriesActSOPInstanceObservationEntryRelationshipSOPInstanceObservation539(SeriesAct, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Series Act SOP Instance Observation Entry Relationship SOP Instance Observation539</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateSeriesActSOPInstanceObservationEntryRelationshipSOPInstanceObservation539(SeriesAct, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Query<?, ?, ?> VALIDATE_SERIES_ACT_SOP_INSTANCE_OBSERVATION_ENTRY_RELATIONSHIP_SOP_INSTANCE_OBSERVATION539__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY;
	...
	public static  boolean validateSeriesActSOPInstanceObservationEntryRelationshipSOPInstanceObservation539(SeriesAct seriesAct, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_SERIES_ACT_SOP_INSTANCE_OBSERVATION_ENTRY_RELATIONSHIP_SOP_INSTANCE_OBSERVATION539__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.SERIES_ACT);
			try {
				OCLExpression<EClassifier> oclExpression = helper.createQuery(VALIDATE_SERIES_ACT_SOP_INSTANCE_OBSERVATION_ENTRY_RELATIONSHIP_SOP_INSTANCE_OBSERVATION539__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
				VALIDATE_SERIES_ACT_SOP_INSTANCE_OBSERVATION_ENTRY_RELATIONSHIP_SOP_INSTANCE_OBSERVATION539__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = EOCL_ENV.createQuery(oclExpression);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		Object oclResult = VALIDATE_SERIES_ACT_SOP_INSTANCE_OBSERVATION_ENTRY_RELATIONSHIP_SOP_INSTANCE_OBSERVATION539__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY.evaluate(seriesAct);		
			...
			if (diagnostics != null) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.SERIES_ACT__SERIES_ACT_SOP_INSTANCE_OBSERVATION_ENTRY_RELATIONSHIP_SOP_INSTANCE_OBSERVATION539,
						 ConsolPlugin.INSTANCE.getString("SeriesActSeriesActSOPInstanceObservationEntryRelationshipSOPInstanceObservation539"),
						 new Object [] { eObject }));
				}
