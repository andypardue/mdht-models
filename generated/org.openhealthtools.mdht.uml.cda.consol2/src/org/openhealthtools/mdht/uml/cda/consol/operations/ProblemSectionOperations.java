 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.consol.ProblemSection#validateProblemSectionEntry108(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Problem Section Entry108</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.consol.ProblemSection#validateProblemSectionProblemConcernActEntryProblemConcern109(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Problem Section Problem Concern Act Entry Problem Concern109</em>}</li>
...
public class ProblemSectionOperations extends ProblemSectionEntriesOptionalOperations {
	...
	/**
	 * The cached OCL expression body for the '{@link #validateProblemSectionEntry108(ProblemSection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Problem Section Entry108</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateProblemSectionEntry108(ProblemSection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_PROBLEM_SECTION_ENTRY108__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.nullFlavor <> vocab::NullFlavor::NI implies entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(cda::Entry))";

	/**
	 * The cached OCL invariant for the '{@link #validateProblemSectionEntry108(ProblemSection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Problem Section Entry108</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateProblemSectionEntry108(ProblemSection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Constraint VALIDATE_PROBLEM_SECTION_ENTRY108__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validateProblemSectionEntry108(ProblemSection problemSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_PROBLEM_SECTION_ENTRY108__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.PROBLEM_SECTION);
			try {
				VALIDATE_PROBLEM_SECTION_ENTRY108__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_PROBLEM_SECTION_ENTRY108__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_PROBLEM_SECTION_ENTRY108__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(problemSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.PROBLEM_SECTION__PROBLEM_SECTION_ENTRY108,
						 ConsolPlugin.INSTANCE.getString("ProblemSectionProblemSectionEntry108"),
	...
	/**
	 * The cached OCL expression body for the '{@link #validateProblemSectionProblemConcernActEntryProblemConcern109(ProblemSection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Problem Section Problem Concern Act Entry Problem Concern109</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateProblemSectionProblemConcernActEntryProblemConcern109(ProblemSection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_PROBLEM_SECTION_PROBLEM_CONCERN_ACT_ENTRY_PROBLEM_CONCERN109__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->excluding(null)->reject(act->exists(act : cda::Act | not act.oclIsUndefined() and act.oclIsKindOf(consol::ProblemConcernAct)))";

	/**
	 * The cached OCL invariant for the '{@link #validateProblemSectionProblemConcernActEntryProblemConcern109(ProblemSection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Problem Section Problem Concern Act Entry Problem Concern109</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateProblemSectionProblemConcernActEntryProblemConcern109(ProblemSection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Query<?, ?, ?> VALIDATE_PROBLEM_SECTION_PROBLEM_CONCERN_ACT_ENTRY_PROBLEM_CONCERN109__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY;
	...
	public static  boolean validateProblemSectionProblemConcernActEntryProblemConcern109(ProblemSection problemSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_PROBLEM_SECTION_PROBLEM_CONCERN_ACT_ENTRY_PROBLEM_CONCERN109__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.PROBLEM_SECTION);
			try {
				OCLExpression<EClassifier> oclExpression = helper.createQuery(VALIDATE_PROBLEM_SECTION_PROBLEM_CONCERN_ACT_ENTRY_PROBLEM_CONCERN109__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
				VALIDATE_PROBLEM_SECTION_PROBLEM_CONCERN_ACT_ENTRY_PROBLEM_CONCERN109__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = EOCL_ENV.createQuery(oclExpression);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		Object oclResult = VALIDATE_PROBLEM_SECTION_PROBLEM_CONCERN_ACT_ENTRY_PROBLEM_CONCERN109__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY.evaluate(problemSection);		
			...
			if (diagnostics != null) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.PROBLEM_SECTION__PROBLEM_SECTION_PROBLEM_CONCERN_ACT_ENTRY_PROBLEM_CONCERN109,
						 ConsolPlugin.INSTANCE.getString("ProblemSectionProblemSectionProblemConcernActEntryProblemConcern109"),
						 new Object [] { eObject }));
				}
