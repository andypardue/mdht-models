...
public class EncountersSectionEntriesOptional2Operations extends EncountersSectionEntriesOptionalOperations {
	...
	/**
	 * The cached OCL expression body for the '{@link #validateEncountersSectionEntriesOptional2Entry1060(EncountersSectionEntriesOptional2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Encounters Section Entries Optional2 Entry1060</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateEncountersSectionEntriesOptional2Entry1060(EncountersSectionEntriesOptional2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_ENCOUNTERS_SECTION_ENTRIES_OPTIONAL2_ENTRY1060__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.nullFlavor <> vocab::NullFlavor::NI implies entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(cda::Entry))";

	/**
	 * The cached OCL invariant for the '{@link #validateEncountersSectionEntriesOptional2Entry1060(EncountersSectionEntriesOptional2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Encounters Section Entries Optional2 Entry1060</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateEncountersSectionEntriesOptional2Entry1060(EncountersSectionEntriesOptional2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Constraint VALIDATE_ENCOUNTERS_SECTION_ENTRIES_OPTIONAL2_ENTRY1060__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validateEncountersSectionEntriesOptional2Entry1060(EncountersSectionEntriesOptional2 encountersSectionEntriesOptional2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_ENCOUNTERS_SECTION_ENTRIES_OPTIONAL2_ENTRY1060__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.ENCOUNTERS_SECTION_ENTRIES_OPTIONAL2);
			try {
				VALIDATE_ENCOUNTERS_SECTION_ENTRIES_OPTIONAL2_ENTRY1060__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_ENCOUNTERS_SECTION_ENTRIES_OPTIONAL2_ENTRY1060__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_ENCOUNTERS_SECTION_ENTRIES_OPTIONAL2_ENTRY1060__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(encountersSectionEntriesOptional2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.ENCOUNTERS_SECTION_ENTRIES_OPTIONAL2__ENCOUNTERS_SECTION_ENTRIES_OPTIONAL2_ENTRY1060,
						 ConsolPlugin.INSTANCE.getString("EncountersSectionEntriesOptional2EncountersSectionEntriesOptional2Entry1060"),
	...
	/**
	 * The cached OCL expression body for the '{@link #validateEncountersSectionEntriesOptional2EncounterActivity2EntryEncounterActivity21061(EncountersSectionEntriesOptional2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Encounters Section Entries Optional2 Encounter Activity2 Entry Encounter Activity21061</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateEncountersSectionEntriesOptional2EncounterActivity2EntryEncounterActivity21061(EncountersSectionEntriesOptional2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The cached OCL invariant for the '{@link #validateEncountersSectionEntriesOptional2EncounterActivity2EntryEncounterActivity21061(EncountersSectionEntriesOptional2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Encounters Section Entries Optional2 Encounter Activity2 Entry Encounter Activity21061</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateEncountersSectionEntriesOptional2EncounterActivity2EntryEncounterActivity21061(EncountersSectionEntriesOptional2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Query<?, ?, ?> VALIDATE_ENCOUNTERS_SECTION_ENTRIES_OPTIONAL2_ENCOUNTER_ACTIVITY2_ENTRY_ENCOUNTER_ACTIVITY21061__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY;
	...
	public static  boolean validateEncountersSectionEntriesOptional2EncounterActivity2EntryEncounterActivity21061(EncountersSectionEntriesOptional2 encountersSectionEntriesOptional2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_ENCOUNTERS_SECTION_ENTRIES_OPTIONAL2_ENCOUNTER_ACTIVITY2_ENTRY_ENCOUNTER_ACTIVITY21061__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.ENCOUNTERS_SECTION_ENTRIES_OPTIONAL2);
			try {
				OCLExpression<EClassifier> oclExpression = helper.createQuery(VALIDATE_ENCOUNTERS_SECTION_ENTRIES_OPTIONAL2_ENCOUNTER_ACTIVITY2_ENTRY_ENCOUNTER_ACTIVITY21061__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
				VALIDATE_ENCOUNTERS_SECTION_ENTRIES_OPTIONAL2_ENCOUNTER_ACTIVITY2_ENTRY_ENCOUNTER_ACTIVITY21061__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = EOCL_ENV.createQuery(oclExpression);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		Object oclResult = VALIDATE_ENCOUNTERS_SECTION_ENTRIES_OPTIONAL2_ENCOUNTER_ACTIVITY2_ENTRY_ENCOUNTER_ACTIVITY21061__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY.evaluate(encountersSectionEntriesOptional2);		
			...
			if (diagnostics != null) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.ENCOUNTERS_SECTION_ENTRIES_OPTIONAL2__ENCOUNTERS_SECTION_ENTRIES_OPTIONAL2_ENCOUNTER_ACTIVITY2_ENTRY_ENCOUNTER_ACTIVITY21061,
						 ConsolPlugin.INSTANCE.getString("EncountersSectionEntriesOptional2EncountersSectionEntriesOptional2EncounterActivity2EntryEncounterActivity21061"),
						 new Object [] { eObject }));
				}
	...
	public static boolean validateEncountersSectionEntriesOptionalTemplateId(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ENCOUNTERS_SECTION_ENTRIES_OPTIONAL_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(encountersSectionEntriesOptional2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateEncountersSectionEntriesOptionalCodeP(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ENCOUNTERS_SECTION_ENTRIES_OPTIONAL_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(encountersSectionEntriesOptional2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
...
"value.code = '46240-8' and value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	public static boolean validateEncountersSectionEntriesOptionalCode(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ENCOUNTERS_SECTION_ENTRIES_OPTIONAL_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(encountersSectionEntriesOptional2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
