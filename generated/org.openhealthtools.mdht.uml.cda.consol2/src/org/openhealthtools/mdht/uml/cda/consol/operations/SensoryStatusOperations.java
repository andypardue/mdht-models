...
public class SensoryStatusOperations extends ClinicalStatementOperations {
	...
	public static boolean validateSensoryStatusTemplateId(SensoryStatus sensoryStatus, DiagnosticChain diagnostics,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SENSORY_STATUS_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(sensoryStatus)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateSensoryStatusClassCode(SensoryStatus sensoryStatus, DiagnosticChain diagnostics,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SENSORY_STATUS_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(sensoryStatus)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateSensoryStatusMoodCode(SensoryStatus sensoryStatus, DiagnosticChain diagnostics,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SENSORY_STATUS_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(sensoryStatus)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
...
"value.code = 'completed')";
	...
	public static boolean validateSensoryStatusStatusCode(SensoryStatus sensoryStatus, DiagnosticChain diagnostics,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SENSORY_STATUS_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(sensoryStatus)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateSensoryStatusStatusCodeP(SensoryStatus sensoryStatus, DiagnosticChain diagnostics,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SENSORY_STATUS_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(sensoryStatus)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateSensoryStatusEffectiveTime(SensoryStatus sensoryStatus, DiagnosticChain diagnostics,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SENSORY_STATUS_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(sensoryStatus)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
...
"value.codeSystem = '2.16.840.1.113883.6.96' and not value.code.oclIsUndefined()))";
	...
	public static boolean validateSensoryStatusAuthorParticipation(SensoryStatus sensoryStatus,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SENSORY_STATUS_AUTHOR_PARTICIPATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(sensoryStatus)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
	...
	/**
	 * The cached OCL expression body for the '{@link #validateSensoryStatusEntryRelationship736(SensoryStatus, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Sensory Status Entry Relationship736</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateSensoryStatusEntryRelationship736(SensoryStatus, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_SENSORY_STATUS_ENTRY_RELATIONSHIP736__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entryRelationship->one(entryRelationship : cda::EntryRelationship | not entryRelationship.oclIsUndefined() and entryRelationship.oclIsKindOf(cda::EntryRelationship))";

	/**
	 * The cached OCL invariant for the '{@link #validateSensoryStatusEntryRelationship736(SensoryStatus, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Sensory Status Entry Relationship736</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateSensoryStatusEntryRelationship736(SensoryStatus, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Constraint VALIDATE_SENSORY_STATUS_ENTRY_RELATIONSHIP736__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validateSensoryStatusEntryRelationship736(SensoryStatus sensoryStatus, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_SENSORY_STATUS_ENTRY_RELATIONSHIP736__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.SENSORY_STATUS);
			try {
				VALIDATE_SENSORY_STATUS_ENTRY_RELATIONSHIP736__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_SENSORY_STATUS_ENTRY_RELATIONSHIP736__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_SENSORY_STATUS_ENTRY_RELATIONSHIP736__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(sensoryStatus)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.SENSORY_STATUS__SENSORY_STATUS_ENTRY_RELATIONSHIP736,
						 ConsolPlugin.INSTANCE.getString("SensoryStatusSensoryStatusEntryRelationship736"),
						 new Object [] { sensoryStatus }));
			}
	...
	/**
	 * The cached OCL expression body for the '{@link #validateSensoryStatusAssessmentScaleObservationEntryRelationshipAssessmentScaleObservation737(SensoryStatus, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Sensory Status Assessment Scale Observation Entry Relationship Assessment Scale Observation737</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateSensoryStatusAssessmentScaleObservationEntryRelationshipAssessmentScaleObservation737(SensoryStatus, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The cached OCL invariant for the '{@link #validateSensoryStatusAssessmentScaleObservationEntryRelationshipAssessmentScaleObservation737(SensoryStatus, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Sensory Status Assessment Scale Observation Entry Relationship Assessment Scale Observation737</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateSensoryStatusAssessmentScaleObservationEntryRelationshipAssessmentScaleObservation737(SensoryStatus, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Query<?, ?, ?> VALIDATE_SENSORY_STATUS_ASSESSMENT_SCALE_OBSERVATION_ENTRY_RELATIONSHIP_ASSESSMENT_SCALE_OBSERVATION737__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY;
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static  boolean validateSensoryStatusAssessmentScaleObservationEntryRelationshipAssessmentScaleObservation737(SensoryStatus sensoryStatus, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_SENSORY_STATUS_ASSESSMENT_SCALE_OBSERVATION_ENTRY_RELATIONSHIP_ASSESSMENT_SCALE_OBSERVATION737__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.SENSORY_STATUS);
			try {
				OCLExpression<EClassifier> oclExpression = helper.createQuery(VALIDATE_SENSORY_STATUS_ASSESSMENT_SCALE_OBSERVATION_ENTRY_RELATIONSHIP_ASSESSMENT_SCALE_OBSERVATION737__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
				VALIDATE_SENSORY_STATUS_ASSESSMENT_SCALE_OBSERVATION_ENTRY_RELATIONSHIP_ASSESSMENT_SCALE_OBSERVATION737__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = EOCL_ENV.createQuery(oclExpression);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		Object oclResult = VALIDATE_SENSORY_STATUS_ASSESSMENT_SCALE_OBSERVATION_ENTRY_RELATIONSHIP_ASSESSMENT_SCALE_OBSERVATION737__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY.evaluate(sensoryStatus);		
		if (oclResult != null && oclResult instanceof Collection) {
			Collection<? extends EObject> oclResultSet = (Collection<? extends EObject>) oclResult;
			...
			if (diagnostics != null) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.SENSORY_STATUS__SENSORY_STATUS_ASSESSMENT_SCALE_OBSERVATION_ENTRY_RELATIONSHIP_ASSESSMENT_SCALE_OBSERVATION737,
						 ConsolPlugin.INSTANCE.getString("SensoryStatusSensoryStatusAssessmentScaleObservationEntryRelationshipAssessmentScaleObservation737"),
						 new Object [] { eObject }));
				}
