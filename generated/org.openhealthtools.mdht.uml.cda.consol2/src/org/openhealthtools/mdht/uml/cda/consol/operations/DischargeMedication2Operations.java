...
public class DischargeMedication2Operations extends DischargeMedicationOperations {
	...
	public static boolean validateDischargeMedicationCodeP(DischargeMedication2 dischargeMedication2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_DISCHARGE_MEDICATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(dischargeMedication2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateDischargeMedication2StatusCode(DischargeMedication2 dischargeMedication2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_DISCHARGE_MEDICATION2_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(dischargeMedication2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateDischargeMedication2StatusCodeP(DischargeMedication2 dischargeMedication2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_DISCHARGE_MEDICATION2_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(dischargeMedication2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  boolean validateDischargeMedication2EntryRelationship902(DischargeMedication2 dischargeMedication2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_DISCHARGE_MEDICATION2_ENTRY_RELATIONSHIP902__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.DISCHARGE_MEDICATION2);
			try {
				VALIDATE_DISCHARGE_MEDICATION2_ENTRY_RELATIONSHIP902__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_DISCHARGE_MEDICATION2_ENTRY_RELATIONSHIP902__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_DISCHARGE_MEDICATION2_ENTRY_RELATIONSHIP902__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(dischargeMedication2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.DISCHARGE_MEDICATION2__DISCHARGE_MEDICATION2_ENTRY_RELATIONSHIP902,
						 ConsolPlugin.INSTANCE.getString("DischargeMedication2DischargeMedication2EntryRelationship902"),
						 new Object [] { dischargeMedication2 }));
			}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static  boolean validateDischargeMedication2MedicationActivity2EntryRelationshipMedicationActivity2903(DischargeMedication2 dischargeMedication2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_DISCHARGE_MEDICATION2_MEDICATION_ACTIVITY2_ENTRY_RELATIONSHIP_MEDICATION_ACTIVITY2903__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.DISCHARGE_MEDICATION2);
			try {
				OCLExpression<EClassifier> oclExpression = helper.createQuery(VALIDATE_DISCHARGE_MEDICATION2_MEDICATION_ACTIVITY2_ENTRY_RELATIONSHIP_MEDICATION_ACTIVITY2903__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
				VALIDATE_DISCHARGE_MEDICATION2_MEDICATION_ACTIVITY2_ENTRY_RELATIONSHIP_MEDICATION_ACTIVITY2903__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = EOCL_ENV.createQuery(oclExpression);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		Object oclResult = VALIDATE_DISCHARGE_MEDICATION2_MEDICATION_ACTIVITY2_ENTRY_RELATIONSHIP_MEDICATION_ACTIVITY2903__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY.evaluate(dischargeMedication2);		
			...
			if (diagnostics != null) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.DISCHARGE_MEDICATION2__DISCHARGE_MEDICATION2_MEDICATION_ACTIVITY2_ENTRY_RELATIONSHIP_MEDICATION_ACTIVITY2903,
						 ConsolPlugin.INSTANCE.getString("DischargeMedication2DischargeMedication2MedicationActivity2EntryRelationshipMedicationActivity2903"),
						 new Object [] { eObject }));
				}
...
"value.code = 'completed')";
	...
	/**
	 * The cached OCL expression body for the '{@link #validateDischargeMedication2EntryRelationship902(DischargeMedication2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Discharge Medication2 Entry Relationship902</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateDischargeMedication2EntryRelationship902(DischargeMedication2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_DISCHARGE_MEDICATION2_ENTRY_RELATIONSHIP902__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entryRelationship->one(entryRelationship : cda::EntryRelationship | not entryRelationship.oclIsUndefined() and entryRelationship.oclIsKindOf(cda::EntryRelationship))";

	/**
	 * The cached OCL invariant for the '{@link #validateDischargeMedication2EntryRelationship902(DischargeMedication2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Discharge Medication2 Entry Relationship902</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateDischargeMedication2EntryRelationship902(DischargeMedication2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Constraint VALIDATE_DISCHARGE_MEDICATION2_ENTRY_RELATIONSHIP902__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;

	/**
	 * The cached OCL expression body for the '{@link #validateDischargeMedication2MedicationActivity2EntryRelationshipMedicationActivity2903(DischargeMedication2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Discharge Medication2 Medication Activity2 Entry Relationship Medication Activity2903</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateDischargeMedication2MedicationActivity2EntryRelationshipMedicationActivity2903(DischargeMedication2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The cached OCL invariant for the '{@link #validateDischargeMedication2MedicationActivity2EntryRelationshipMedicationActivity2903(DischargeMedication2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Discharge Medication2 Medication Activity2 Entry Relationship Medication Activity2903</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateDischargeMedication2MedicationActivity2EntryRelationshipMedicationActivity2903(DischargeMedication2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Query<?, ?, ?> VALIDATE_DISCHARGE_MEDICATION2_MEDICATION_ACTIVITY2_ENTRY_RELATIONSHIP_MEDICATION_ACTIVITY2903__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY;
	...
	public static boolean validateDischargeMedicationTemplateId(DischargeMedication2 dischargeMedication2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_DISCHARGE_MEDICATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(dischargeMedication2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
...
"value.code = '75311-1' and value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	public static boolean validateDischargeMedicationCode(DischargeMedication2 dischargeMedication2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_DISCHARGE_MEDICATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(dischargeMedication2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
