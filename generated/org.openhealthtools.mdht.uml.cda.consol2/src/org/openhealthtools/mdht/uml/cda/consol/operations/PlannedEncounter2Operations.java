...
public class PlannedEncounter2Operations extends PlanOfCareActivityEncounterOperations {
	...
	public static boolean validatePlannedEncounter2ParticipantServiceDeliveryLocationTypeCode(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_ENCOUNTER2_PARTICIPANT_SERVICE_DELIVERY_LOCATION_TYPE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedEncounter2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validatePlannedEncounter2Code(PlannedEncounter2 plannedEncounter2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_ENCOUNTER2_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedEncounter2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
...
"value.codeSystem = '2.16.840.1.113883.6.96' and not value.code.oclIsUndefined())";
	...
	public static boolean validatePlannedEncounter2CodeP(PlannedEncounter2 plannedEncounter2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_ENCOUNTER2_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedEncounter2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
...
"value.code = 'active')";
	...
	public static boolean validatePlannedEncounter2StatusCode(PlannedEncounter2 plannedEncounter2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_ENCOUNTER2_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedEncounter2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validatePlannedEncounter2StatusCodeP(PlannedEncounter2 plannedEncounter2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_ENCOUNTER2_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedEncounter2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validatePlannedEncounter2EffectiveTime(PlannedEncounter2 plannedEncounter2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_ENCOUNTER2_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedEncounter2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
	...
	public static boolean validatePlannedEncounter2Performer(PlannedEncounter2 plannedEncounter2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_ENCOUNTER2_PERFORMER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedEncounter2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_PLANNED_ENCOUNTER2_SERVICE_DELIVERY_LOCATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.participant->exists(participant : cda::Participant2 | not participant.oclIsUndefined() and participant.oclIsKindOf(consol::ServiceDeliveryLocation))";
	...
	public static boolean validatePlannedEncounter2ServiceDeliveryLocation(PlannedEncounter2 plannedEncounter2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_ENCOUNTER2_SERVICE_DELIVERY_LOCATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedEncounter2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
	...
	public static boolean validatePlannedEncounter2AuthorParticipation(PlannedEncounter2 plannedEncounter2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_ENCOUNTER2_AUTHOR_PARTICIPATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedEncounter2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
	...
	/**
	 * The cached OCL expression body for the '{@link #validatePlannedEncounter2EntryRelationship964(PlannedEncounter2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Planned Encounter2 Entry Relationship964</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePlannedEncounter2EntryRelationship964(PlannedEncounter2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_PLANNED_ENCOUNTER2_ENTRY_RELATIONSHIP964__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entryRelationship->one(entryRelationship : cda::EntryRelationship | not entryRelationship.oclIsUndefined() and entryRelationship.oclIsKindOf(cda::EntryRelationship))";

	/**
	 * The cached OCL invariant for the '{@link #validatePlannedEncounter2EntryRelationship964(PlannedEncounter2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Planned Encounter2 Entry Relationship964</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePlannedEncounter2EntryRelationship964(PlannedEncounter2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Constraint VALIDATE_PLANNED_ENCOUNTER2_ENTRY_RELATIONSHIP964__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validatePlannedEncounter2EntryRelationship964(PlannedEncounter2 plannedEncounter2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_PLANNED_ENCOUNTER2_ENTRY_RELATIONSHIP964__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.PLANNED_ENCOUNTER2);
			try {
				VALIDATE_PLANNED_ENCOUNTER2_ENTRY_RELATIONSHIP964__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_PLANNED_ENCOUNTER2_ENTRY_RELATIONSHIP964__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_ENCOUNTER2_ENTRY_RELATIONSHIP964__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedEncounter2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.PLANNED_ENCOUNTER2__PLANNED_ENCOUNTER2_ENTRY_RELATIONSHIP964,
						 ConsolPlugin.INSTANCE.getString("PlannedEncounter2PlannedEncounter2EntryRelationship964"),
						 new Object [] { plannedEncounter2 }));
			}
	...
	/**
	 * The cached OCL expression body for the '{@link #validatePlannedEncounter2EntryRelationship966(PlannedEncounter2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Planned Encounter2 Entry Relationship966</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePlannedEncounter2EntryRelationship966(PlannedEncounter2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_PLANNED_ENCOUNTER2_ENTRY_RELATIONSHIP966__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entryRelationship->one(entryRelationship : cda::EntryRelationship | not entryRelationship.oclIsUndefined() and entryRelationship.oclIsKindOf(cda::EntryRelationship))";

	/**
	 * The cached OCL invariant for the '{@link #validatePlannedEncounter2EntryRelationship966(PlannedEncounter2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Planned Encounter2 Entry Relationship966</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePlannedEncounter2EntryRelationship966(PlannedEncounter2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Constraint VALIDATE_PLANNED_ENCOUNTER2_ENTRY_RELATIONSHIP966__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validatePlannedEncounter2EntryRelationship966(PlannedEncounter2 plannedEncounter2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_PLANNED_ENCOUNTER2_ENTRY_RELATIONSHIP966__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.PLANNED_ENCOUNTER2);
			try {
				VALIDATE_PLANNED_ENCOUNTER2_ENTRY_RELATIONSHIP966__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_PLANNED_ENCOUNTER2_ENTRY_RELATIONSHIP966__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_ENCOUNTER2_ENTRY_RELATIONSHIP966__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedEncounter2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.PLANNED_ENCOUNTER2__PLANNED_ENCOUNTER2_ENTRY_RELATIONSHIP966,
						 ConsolPlugin.INSTANCE.getString("PlannedEncounter2PlannedEncounter2EntryRelationship966"),
						 new Object [] { plannedEncounter2 }));
			}
	...
	/**
	 * The cached OCL expression body for the '{@link #validatePlannedEncounter2PriorityPreferenceEntryRelationshipPriorityPreference965(PlannedEncounter2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Planned Encounter2 Priority Preference Entry Relationship Priority Preference965</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePlannedEncounter2PriorityPreferenceEntryRelationshipPriorityPreference965(PlannedEncounter2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The cached OCL invariant for the '{@link #validatePlannedEncounter2PriorityPreferenceEntryRelationshipPriorityPreference965(PlannedEncounter2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Planned Encounter2 Priority Preference Entry Relationship Priority Preference965</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePlannedEncounter2PriorityPreferenceEntryRelationshipPriorityPreference965(PlannedEncounter2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Query<?, ?, ?> VALIDATE_PLANNED_ENCOUNTER2_PRIORITY_PREFERENCE_ENTRY_RELATIONSHIP_PRIORITY_PREFERENCE965__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY;
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static  boolean validatePlannedEncounter2PriorityPreferenceEntryRelationshipPriorityPreference965(PlannedEncounter2 plannedEncounter2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_PLANNED_ENCOUNTER2_PRIORITY_PREFERENCE_ENTRY_RELATIONSHIP_PRIORITY_PREFERENCE965__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.PLANNED_ENCOUNTER2);
			try {
				OCLExpression<EClassifier> oclExpression = helper.createQuery(VALIDATE_PLANNED_ENCOUNTER2_PRIORITY_PREFERENCE_ENTRY_RELATIONSHIP_PRIORITY_PREFERENCE965__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
				VALIDATE_PLANNED_ENCOUNTER2_PRIORITY_PREFERENCE_ENTRY_RELATIONSHIP_PRIORITY_PREFERENCE965__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = EOCL_ENV.createQuery(oclExpression);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		Object oclResult = VALIDATE_PLANNED_ENCOUNTER2_PRIORITY_PREFERENCE_ENTRY_RELATIONSHIP_PRIORITY_PREFERENCE965__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY.evaluate(plannedEncounter2);		
		if (oclResult != null && oclResult instanceof Collection) {
			Collection<? extends EObject> oclResultSet = (Collection<? extends EObject>) oclResult;
			...
			if (diagnostics != null) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.PLANNED_ENCOUNTER2__PLANNED_ENCOUNTER2_PRIORITY_PREFERENCE_ENTRY_RELATIONSHIP_PRIORITY_PREFERENCE965,
						 ConsolPlugin.INSTANCE.getString("PlannedEncounter2PlannedEncounter2PriorityPreferenceEntryRelationshipPriorityPreference965"),
						 new Object [] { eObject }));
				}
	...
	/**
	 * The cached OCL expression body for the '{@link #validatePlannedEncounter2Indication2EntryRelationshipIndication2967(PlannedEncounter2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Planned Encounter2 Indication2 Entry Relationship Indication2967</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePlannedEncounter2Indication2EntryRelationshipIndication2967(PlannedEncounter2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The cached OCL invariant for the '{@link #validatePlannedEncounter2Indication2EntryRelationshipIndication2967(PlannedEncounter2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Planned Encounter2 Indication2 Entry Relationship Indication2967</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePlannedEncounter2Indication2EntryRelationshipIndication2967(PlannedEncounter2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Query<?, ?, ?> VALIDATE_PLANNED_ENCOUNTER2_INDICATION2_ENTRY_RELATIONSHIP_INDICATION2967__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY;
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static  boolean validatePlannedEncounter2Indication2EntryRelationshipIndication2967(PlannedEncounter2 plannedEncounter2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_PLANNED_ENCOUNTER2_INDICATION2_ENTRY_RELATIONSHIP_INDICATION2967__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.PLANNED_ENCOUNTER2);
			try {
				OCLExpression<EClassifier> oclExpression = helper.createQuery(VALIDATE_PLANNED_ENCOUNTER2_INDICATION2_ENTRY_RELATIONSHIP_INDICATION2967__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
				VALIDATE_PLANNED_ENCOUNTER2_INDICATION2_ENTRY_RELATIONSHIP_INDICATION2967__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = EOCL_ENV.createQuery(oclExpression);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		Object oclResult = VALIDATE_PLANNED_ENCOUNTER2_INDICATION2_ENTRY_RELATIONSHIP_INDICATION2967__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY.evaluate(plannedEncounter2);		
		if (oclResult != null && oclResult instanceof Collection) {
			Collection<? extends EObject> oclResultSet = (Collection<? extends EObject>) oclResult;
			...
			if (diagnostics != null) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.PLANNED_ENCOUNTER2__PLANNED_ENCOUNTER2_INDICATION2_ENTRY_RELATIONSHIP_INDICATION2967,
						 ConsolPlugin.INSTANCE.getString("PlannedEncounter2PlannedEncounter2Indication2EntryRelationshipIndication2967"),
						 new Object [] { eObject }));
				}
	...
	public static boolean validatePlanOfCareActivityEncounterTemplateId(PlannedEncounter2 plannedEncounter2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLAN_OF_CARE_ACTIVITY_ENCOUNTER_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedEncounter2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
...
"value = vocab::x_DocumentEncounterMood::INT or value = vocab::x_DocumentEncounterMood::ARQ or value = vocab::x_DocumentEncounterMood::PRMS or value = vocab::x_DocumentEncounterMood::PRP or value = vocab::x_DocumentEncounterMood::RQO";
	...
	public static boolean validatePlanOfCareActivityEncounterMoodCode(PlannedEncounter2 plannedEncounter2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLAN_OF_CARE_ACTIVITY_ENCOUNTER_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedEncounter2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
