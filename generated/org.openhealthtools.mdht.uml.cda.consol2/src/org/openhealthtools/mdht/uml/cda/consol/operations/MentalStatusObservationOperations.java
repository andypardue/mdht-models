...
public class MentalStatusObservationOperations extends ClinicalStatementOperations {
	...
	public static boolean validateMentalStatusObservationTemplateId(MentalStatusObservation mentalStatusObservation,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_MENTAL_STATUS_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(mentalStatusObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateMentalStatusObservationClassCode(MentalStatusObservation mentalStatusObservation,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_MENTAL_STATUS_OBSERVATION_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(mentalStatusObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateMentalStatusObservationMoodCode(MentalStatusObservation mentalStatusObservation,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_MENTAL_STATUS_OBSERVATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(mentalStatusObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_MENTAL_STATUS_OBSERVATION_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.id->isEmpty() or self.id->exists(element | element.isNullFlavorUndefined())) implies (self.id->size() >= 1)";
	...
	public static boolean validateMentalStatusObservationId(MentalStatusObservation mentalStatusObservation,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_MENTAL_STATUS_OBSERVATION_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(mentalStatusObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateMentalStatusObservationCodeP(MentalStatusObservation mentalStatusObservation,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_MENTAL_STATUS_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(mentalStatusObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
...
"value.codeSystem = '2.16.840.1.113883.6.96' and (value.code = '43173001' or value.code = '405051006' or value.code = '363871006' or value.code = '85256008' or value.code = '285231000' or value.code = '6942003'))";
	...
	public static boolean validateMentalStatusObservationCode(MentalStatusObservation mentalStatusObservation,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_MENTAL_STATUS_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(mentalStatusObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
...
"value.code = 'completed')";
	...
	public static boolean validateMentalStatusObservationStatusCode(MentalStatusObservation mentalStatusObservation,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_MENTAL_STATUS_OBSERVATION_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(mentalStatusObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateMentalStatusObservationStatusCodeP(MentalStatusObservation mentalStatusObservation,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_MENTAL_STATUS_OBSERVATION_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(mentalStatusObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateMentalStatusObservationEffectiveTime(MentalStatusObservation mentalStatusObservation,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_MENTAL_STATUS_OBSERVATION_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(mentalStatusObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
...
"value.codeSystem = '2.16.840.1.113883.6.96' and not value.code.oclIsUndefined()))";
	...
	public static boolean validateMentalStatusObservationValue(MentalStatusObservation mentalStatusObservation,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_MENTAL_STATUS_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(mentalStatusObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
	...
	public static boolean validateMentalStatusObservationValueP(MentalStatusObservation mentalStatusObservation,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_MENTAL_STATUS_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(mentalStatusObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateMentalStatusObservationAuthorParticipation(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_MENTAL_STATUS_OBSERVATION_AUTHOR_PARTICIPATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(mentalStatusObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
	...
	/**
	 * The cached OCL expression body for the '{@link #validateMentalStatusObservationEntryRelationship600(MentalStatusObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Mental Status Observation Entry Relationship600</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateMentalStatusObservationEntryRelationship600(MentalStatusObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_MENTAL_STATUS_OBSERVATION_ENTRY_RELATIONSHIP600__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entryRelationship->one(entryRelationship : cda::EntryRelationship | not entryRelationship.oclIsUndefined() and entryRelationship.oclIsKindOf(cda::EntryRelationship))";

	/**
	 * The cached OCL invariant for the '{@link #validateMentalStatusObservationEntryRelationship600(MentalStatusObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Mental Status Observation Entry Relationship600</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateMentalStatusObservationEntryRelationship600(MentalStatusObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Constraint VALIDATE_MENTAL_STATUS_OBSERVATION_ENTRY_RELATIONSHIP600__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validateMentalStatusObservationEntryRelationship600(MentalStatusObservation mentalStatusObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_MENTAL_STATUS_OBSERVATION_ENTRY_RELATIONSHIP600__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.MENTAL_STATUS_OBSERVATION);
			try {
				VALIDATE_MENTAL_STATUS_OBSERVATION_ENTRY_RELATIONSHIP600__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_MENTAL_STATUS_OBSERVATION_ENTRY_RELATIONSHIP600__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_MENTAL_STATUS_OBSERVATION_ENTRY_RELATIONSHIP600__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(mentalStatusObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.MENTAL_STATUS_OBSERVATION__MENTAL_STATUS_OBSERVATION_ENTRY_RELATIONSHIP600,
						 ConsolPlugin.INSTANCE.getString("MentalStatusObservationMentalStatusObservationEntryRelationship600"),
						 new Object [] { mentalStatusObservation }));
			}
	...
	/**
	 * The cached OCL expression body for the '{@link #validateMentalStatusObservationAssessmentScaleObservationEntryRelationshipAssessmentScaleObservation601(MentalStatusObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Mental Status Observation Assessment Scale Observation Entry Relationship Assessment Scale Observation601</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateMentalStatusObservationAssessmentScaleObservationEntryRelationshipAssessmentScaleObservation601(MentalStatusObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The cached OCL invariant for the '{@link #validateMentalStatusObservationAssessmentScaleObservationEntryRelationshipAssessmentScaleObservation601(MentalStatusObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Mental Status Observation Assessment Scale Observation Entry Relationship Assessment Scale Observation601</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateMentalStatusObservationAssessmentScaleObservationEntryRelationshipAssessmentScaleObservation601(MentalStatusObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Query<?, ?, ?> VALIDATE_MENTAL_STATUS_OBSERVATION_ASSESSMENT_SCALE_OBSERVATION_ENTRY_RELATIONSHIP_ASSESSMENT_SCALE_OBSERVATION601__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY;
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static  boolean validateMentalStatusObservationAssessmentScaleObservationEntryRelationshipAssessmentScaleObservation601(MentalStatusObservation mentalStatusObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_MENTAL_STATUS_OBSERVATION_ASSESSMENT_SCALE_OBSERVATION_ENTRY_RELATIONSHIP_ASSESSMENT_SCALE_OBSERVATION601__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.MENTAL_STATUS_OBSERVATION);
			try {
				OCLExpression<EClassifier> oclExpression = helper.createQuery(VALIDATE_MENTAL_STATUS_OBSERVATION_ASSESSMENT_SCALE_OBSERVATION_ENTRY_RELATIONSHIP_ASSESSMENT_SCALE_OBSERVATION601__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
				VALIDATE_MENTAL_STATUS_OBSERVATION_ASSESSMENT_SCALE_OBSERVATION_ENTRY_RELATIONSHIP_ASSESSMENT_SCALE_OBSERVATION601__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = EOCL_ENV.createQuery(oclExpression);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		Object oclResult = VALIDATE_MENTAL_STATUS_OBSERVATION_ASSESSMENT_SCALE_OBSERVATION_ENTRY_RELATIONSHIP_ASSESSMENT_SCALE_OBSERVATION601__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY.evaluate(mentalStatusObservation);		
			...
			if (diagnostics != null) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.MENTAL_STATUS_OBSERVATION__MENTAL_STATUS_OBSERVATION_ASSESSMENT_SCALE_OBSERVATION_ENTRY_RELATIONSHIP_ASSESSMENT_SCALE_OBSERVATION601,
						 ConsolPlugin.INSTANCE.getString("MentalStatusObservationMentalStatusObservationAssessmentScaleObservationEntryRelationshipAssessmentScaleObservation601"),
						 new Object [] { eObject }));
				}
