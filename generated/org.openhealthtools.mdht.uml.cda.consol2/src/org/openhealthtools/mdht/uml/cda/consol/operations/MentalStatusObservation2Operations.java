...
public class MentalStatusObservation2Operations extends ClinicalStatementOperations {
	...
	public static boolean validateMentalStatusObservation2ValueDatatype(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_MENTAL_STATUS_OBSERVATION2_VALUE_DATATYPE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(mentalStatusObservation2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
	...
	public static boolean validateMentalStatusObservation2TemplateId(MentalStatusObservation2 mentalStatusObservation2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_MENTAL_STATUS_OBSERVATION2_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(mentalStatusObservation2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateMentalStatusObservation2ClassCode(MentalStatusObservation2 mentalStatusObservation2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_MENTAL_STATUS_OBSERVATION2_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(mentalStatusObservation2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateMentalStatusObservation2MoodCode(MentalStatusObservation2 mentalStatusObservation2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_MENTAL_STATUS_OBSERVATION2_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(mentalStatusObservation2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_MENTAL_STATUS_OBSERVATION2_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.id->isEmpty() or self.id->exists(element | element.isNullFlavorUndefined())) implies (self.id->size() >= 1)";
	...
	public static boolean validateMentalStatusObservation2Id(MentalStatusObservation2 mentalStatusObservation2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_MENTAL_STATUS_OBSERVATION2_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(mentalStatusObservation2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateMentalStatusObservation2CodeP(MentalStatusObservation2 mentalStatusObservation2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_MENTAL_STATUS_OBSERVATION2_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(mentalStatusObservation2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
...
"value.code = '373930000' and value.codeSystem = '2.16.840.1.113883.6.96')";
	...
	public static boolean validateMentalStatusObservation2Code(MentalStatusObservation2 mentalStatusObservation2,
		...
		Object passToken = (context == null) ? null : context.get("org.openhealthtools.mdht.uml.cda.consol.MentalStatusObservation2CodeP");
		...
		if (!EOCL_ENV.createQuery(VALIDATE_MENTAL_STATUS_OBSERVATION2_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(mentalStatusObservation2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
...
"value.code = 'completed')";
	...
	public static boolean validateMentalStatusObservation2StatusCode(MentalStatusObservation2 mentalStatusObservation2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_MENTAL_STATUS_OBSERVATION2_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(mentalStatusObservation2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateMentalStatusObservation2StatusCodeP(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_MENTAL_STATUS_OBSERVATION2_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(mentalStatusObservation2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateMentalStatusObservation2EffectiveTime(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_MENTAL_STATUS_OBSERVATION2_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(mentalStatusObservation2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateMentalStatusObservation2Value(MentalStatusObservation2 mentalStatusObservation2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_MENTAL_STATUS_OBSERVATION2_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(mentalStatusObservation2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateMentalStatusObservation2AuthorParticipation(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_MENTAL_STATUS_OBSERVATION2_AUTHOR_PARTICIPATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(mentalStatusObservation2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
	...
	public static boolean validateMentalStatusObservation2ReferenceRange(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_MENTAL_STATUS_OBSERVATION2_REFERENCE_RANGE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(mentalStatusObservation2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
	...
	/**
	 * The cached OCL expression body for the '{@link #validateMentalStatusObservation2EntryRelationship1050(MentalStatusObservation2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Mental Status Observation2 Entry Relationship1050</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateMentalStatusObservation2EntryRelationship1050(MentalStatusObservation2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_MENTAL_STATUS_OBSERVATION2_ENTRY_RELATIONSHIP1050__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entryRelationship->one(entryRelationship : cda::EntryRelationship | not entryRelationship.oclIsUndefined() and entryRelationship.oclIsKindOf(cda::EntryRelationship))";

	/**
	 * The cached OCL invariant for the '{@link #validateMentalStatusObservation2EntryRelationship1050(MentalStatusObservation2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Mental Status Observation2 Entry Relationship1050</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateMentalStatusObservation2EntryRelationship1050(MentalStatusObservation2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Constraint VALIDATE_MENTAL_STATUS_OBSERVATION2_ENTRY_RELATIONSHIP1050__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validateMentalStatusObservation2EntryRelationship1050(MentalStatusObservation2 mentalStatusObservation2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_MENTAL_STATUS_OBSERVATION2_ENTRY_RELATIONSHIP1050__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.MENTAL_STATUS_OBSERVATION2);
			try {
				VALIDATE_MENTAL_STATUS_OBSERVATION2_ENTRY_RELATIONSHIP1050__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_MENTAL_STATUS_OBSERVATION2_ENTRY_RELATIONSHIP1050__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_MENTAL_STATUS_OBSERVATION2_ENTRY_RELATIONSHIP1050__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(mentalStatusObservation2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.MENTAL_STATUS_OBSERVATION2__MENTAL_STATUS_OBSERVATION2_ENTRY_RELATIONSHIP1050,
						 ConsolPlugin.INSTANCE.getString("MentalStatusObservation2MentalStatusObservation2EntryRelationship1050"),
						 new Object [] { mentalStatusObservation2 }));
			}
...
"value.code = '75275-8' and value.codeSystem = '2.16.840.1.113883.6.1')) )))";
	...
	/**
	 * The cached OCL expression body for the '{@link #validateMentalStatusObservation2AssessmentScaleObservationEntryRelationshipAssessmentScaleObservation1051(MentalStatusObservation2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Mental Status Observation2 Assessment Scale Observation Entry Relationship Assessment Scale Observation1051</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateMentalStatusObservation2AssessmentScaleObservationEntryRelationshipAssessmentScaleObservation1051(MentalStatusObservation2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The cached OCL invariant for the '{@link #validateMentalStatusObservation2AssessmentScaleObservationEntryRelationshipAssessmentScaleObservation1051(MentalStatusObservation2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Mental Status Observation2 Assessment Scale Observation Entry Relationship Assessment Scale Observation1051</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateMentalStatusObservation2AssessmentScaleObservationEntryRelationshipAssessmentScaleObservation1051(MentalStatusObservation2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Query<?, ?, ?> VALIDATE_MENTAL_STATUS_OBSERVATION2_ASSESSMENT_SCALE_OBSERVATION_ENTRY_RELATIONSHIP_ASSESSMENT_SCALE_OBSERVATION1051__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY;
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static  boolean validateMentalStatusObservation2AssessmentScaleObservationEntryRelationshipAssessmentScaleObservation1051(MentalStatusObservation2 mentalStatusObservation2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_MENTAL_STATUS_OBSERVATION2_ASSESSMENT_SCALE_OBSERVATION_ENTRY_RELATIONSHIP_ASSESSMENT_SCALE_OBSERVATION1051__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.MENTAL_STATUS_OBSERVATION2);
			try {
				OCLExpression<EClassifier> oclExpression = helper.createQuery(VALIDATE_MENTAL_STATUS_OBSERVATION2_ASSESSMENT_SCALE_OBSERVATION_ENTRY_RELATIONSHIP_ASSESSMENT_SCALE_OBSERVATION1051__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
				VALIDATE_MENTAL_STATUS_OBSERVATION2_ASSESSMENT_SCALE_OBSERVATION_ENTRY_RELATIONSHIP_ASSESSMENT_SCALE_OBSERVATION1051__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = EOCL_ENV.createQuery(oclExpression);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		Object oclResult = VALIDATE_MENTAL_STATUS_OBSERVATION2_ASSESSMENT_SCALE_OBSERVATION_ENTRY_RELATIONSHIP_ASSESSMENT_SCALE_OBSERVATION1051__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY.evaluate(mentalStatusObservation2);		
		if (oclResult != null && oclResult instanceof Collection) {
			Collection<? extends EObject> oclResultSet = (Collection<? extends EObject>) oclResult;
			...
			if (diagnostics != null) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.MENTAL_STATUS_OBSERVATION2__MENTAL_STATUS_OBSERVATION2_ASSESSMENT_SCALE_OBSERVATION_ENTRY_RELATIONSHIP_ASSESSMENT_SCALE_OBSERVATION1051,
						 ConsolPlugin.INSTANCE.getString("MentalStatusObservation2MentalStatusObservation2AssessmentScaleObservationEntryRelationshipAssessmentScaleObservation1051"),
						 new Object [] { eObject }));
				}
