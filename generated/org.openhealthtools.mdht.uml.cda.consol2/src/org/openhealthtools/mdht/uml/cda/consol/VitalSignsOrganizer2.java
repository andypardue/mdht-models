 ...
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/consolVitalSignsOrganizer2VitalSignObservation2EntryRelationship constraints.validation.error='VitalSignsOrganizer2VitalSignObservation2EntryRelationshipVitalSignObservation21049'"
 * @generated
 */
public interface VitalSignsOrganizer2 extends VitalSignsOrganizer {
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.->reject(observation->exists(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(consol::VitalSignObservation2)))'"
	 * @generated
	 */
	boolean validateVitalSignsOrganizer2VitalSignObservation2EntryRelationshipVitalSignObservation21049(DiagnosticChain diagnostics, Map<Object, Object> context);
