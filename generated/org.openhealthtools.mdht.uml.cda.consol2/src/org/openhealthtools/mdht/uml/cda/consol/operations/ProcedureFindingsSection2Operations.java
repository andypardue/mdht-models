...
public class ProcedureFindingsSection2Operations extends ProcedureFindingsSectionOperations {
	...
	/**
	 * The cached OCL expression body for the '{@link #validateProcedureFindingsSection2Entry1146(ProcedureFindingsSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Procedure Findings Section2 Entry1146</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateProcedureFindingsSection2Entry1146(ProcedureFindingsSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_PROCEDURE_FINDINGS_SECTION2_ENTRY1146__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.nullFlavor <> vocab::NullFlavor::NI implies entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(cda::Entry))";

	/**
	 * The cached OCL invariant for the '{@link #validateProcedureFindingsSection2Entry1146(ProcedureFindingsSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Procedure Findings Section2 Entry1146</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateProcedureFindingsSection2Entry1146(ProcedureFindingsSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Constraint VALIDATE_PROCEDURE_FINDINGS_SECTION2_ENTRY1146__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validateProcedureFindingsSection2Entry1146(ProcedureFindingsSection2 procedureFindingsSection2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_PROCEDURE_FINDINGS_SECTION2_ENTRY1146__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.PROCEDURE_FINDINGS_SECTION2);
			try {
				VALIDATE_PROCEDURE_FINDINGS_SECTION2_ENTRY1146__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_PROCEDURE_FINDINGS_SECTION2_ENTRY1146__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_PROCEDURE_FINDINGS_SECTION2_ENTRY1146__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(procedureFindingsSection2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.PROCEDURE_FINDINGS_SECTION2__PROCEDURE_FINDINGS_SECTION2_ENTRY1146,
						 ConsolPlugin.INSTANCE.getString("ProcedureFindingsSection2ProcedureFindingsSection2Entry1146"),
	...
	/**
	 * The cached OCL expression body for the '{@link #validateProcedureFindingsSection2ProblemObservation2EntryProblemObservation21147(ProcedureFindingsSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Procedure Findings Section2 Problem Observation2 Entry Problem Observation21147</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateProcedureFindingsSection2ProblemObservation2EntryProblemObservation21147(ProcedureFindingsSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The cached OCL invariant for the '{@link #validateProcedureFindingsSection2ProblemObservation2EntryProblemObservation21147(ProcedureFindingsSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Procedure Findings Section2 Problem Observation2 Entry Problem Observation21147</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateProcedureFindingsSection2ProblemObservation2EntryProblemObservation21147(ProcedureFindingsSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Query<?, ?, ?> VALIDATE_PROCEDURE_FINDINGS_SECTION2_PROBLEM_OBSERVATION2_ENTRY_PROBLEM_OBSERVATION21147__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY;
	...
	public static  boolean validateProcedureFindingsSection2ProblemObservation2EntryProblemObservation21147(ProcedureFindingsSection2 procedureFindingsSection2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_PROCEDURE_FINDINGS_SECTION2_PROBLEM_OBSERVATION2_ENTRY_PROBLEM_OBSERVATION21147__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.PROCEDURE_FINDINGS_SECTION2);
			try {
				OCLExpression<EClassifier> oclExpression = helper.createQuery(VALIDATE_PROCEDURE_FINDINGS_SECTION2_PROBLEM_OBSERVATION2_ENTRY_PROBLEM_OBSERVATION21147__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
				VALIDATE_PROCEDURE_FINDINGS_SECTION2_PROBLEM_OBSERVATION2_ENTRY_PROBLEM_OBSERVATION21147__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = EOCL_ENV.createQuery(oclExpression);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		Object oclResult = VALIDATE_PROCEDURE_FINDINGS_SECTION2_PROBLEM_OBSERVATION2_ENTRY_PROBLEM_OBSERVATION21147__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY.evaluate(procedureFindingsSection2);		
			...
			if (diagnostics != null) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.PROCEDURE_FINDINGS_SECTION2__PROCEDURE_FINDINGS_SECTION2_PROBLEM_OBSERVATION2_ENTRY_PROBLEM_OBSERVATION21147,
						 ConsolPlugin.INSTANCE.getString("ProcedureFindingsSection2ProcedureFindingsSection2ProblemObservation2EntryProblemObservation21147"),
						 new Object [] { eObject }));
				}
	...
	public static boolean validateProcedureFindingsSectionTemplateId(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PROCEDURE_FINDINGS_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(procedureFindingsSection2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateProcedureFindingsSectionCodeP(ProcedureFindingsSection2 procedureFindingsSection2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PROCEDURE_FINDINGS_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(procedureFindingsSection2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
...
"value.code = '59776-5' and value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	public static boolean validateProcedureFindingsSectionCode(ProcedureFindingsSection2 procedureFindingsSection2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PROCEDURE_FINDINGS_SECTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(procedureFindingsSection2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
