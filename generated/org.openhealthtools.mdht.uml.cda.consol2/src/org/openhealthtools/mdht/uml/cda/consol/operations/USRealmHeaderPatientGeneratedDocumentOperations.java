...
public class USRealmHeaderPatientGeneratedDocumentOperations extends USRealmHeader2Operations {
	...
	public static boolean validateUSRealmHeaderPatientGeneratedDocumentRecordTarget(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_US_REALM_HEADER_PATIENT_GENERATED_DOCUMENT_RECORD_TARGET__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(usRealmHeaderPatientGeneratedDocument)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateUSRealmHeaderPatientGeneratedDocumentAuthor(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_US_REALM_HEADER_PATIENT_GENERATED_DOCUMENT_AUTHOR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(usRealmHeaderPatientGeneratedDocument)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateUSRealmHeaderPatientGeneratedDocumentDataEnterer(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_US_REALM_HEADER_PATIENT_GENERATED_DOCUMENT_DATA_ENTERER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(usRealmHeaderPatientGeneratedDocument)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
	...
	public static boolean validateUSRealmHeaderPatientGeneratedDocumentInformant(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_US_REALM_HEADER_PATIENT_GENERATED_DOCUMENT_INFORMANT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(usRealmHeaderPatientGeneratedDocument)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
	...
	public static boolean validateUSRealmHeaderPatientGeneratedDocumentCustodian(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_US_REALM_HEADER_PATIENT_GENERATED_DOCUMENT_CUSTODIAN__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(usRealmHeaderPatientGeneratedDocument)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateUSRealmHeaderPatientGeneratedDocumentInformationRecipient(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_US_REALM_HEADER_PATIENT_GENERATED_DOCUMENT_INFORMATION_RECIPIENT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(usRealmHeaderPatientGeneratedDocument)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
	...
	public static boolean validateUSRealmHeaderPatientGeneratedDocumentLegalAuthenticator(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_US_REALM_HEADER_PATIENT_GENERATED_DOCUMENT_LEGAL_AUTHENTICATOR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(usRealmHeaderPatientGeneratedDocument)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
	...
	public static boolean validateUSRealmHeaderPatientGeneratedDocumentAuthenticator(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_US_REALM_HEADER_PATIENT_GENERATED_DOCUMENT_AUTHENTICATOR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(usRealmHeaderPatientGeneratedDocument)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
	...
	public static boolean validateUSRealmHeaderPatientGeneratedDocumentParticipant(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_US_REALM_HEADER_PATIENT_GENERATED_DOCUMENT_PARTICIPANT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(usRealmHeaderPatientGeneratedDocument)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
	...
	public static boolean validateUSRealmHeaderPatientGeneratedDocumentInFulfillmentOf(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_US_REALM_HEADER_PATIENT_GENERATED_DOCUMENT_IN_FULFILLMENT_OF__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(usRealmHeaderPatientGeneratedDocument)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
	...
	public static boolean validateUSRealmHeaderPatientGeneratedDocumentDocumentationOf(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_US_REALM_HEADER_PATIENT_GENERATED_DOCUMENT_DOCUMENTATION_OF__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(usRealmHeaderPatientGeneratedDocument)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
...
"value.codeSystem = '2.16.840.1.113883.5.90' and not value.code.oclIsUndefined()))";
	...
	public static boolean validateGeneralHeaderConstraintsTemplateId(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_GENERAL_HEADER_CONSTRAINTS_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(usRealmHeaderPatientGeneratedDocument)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
