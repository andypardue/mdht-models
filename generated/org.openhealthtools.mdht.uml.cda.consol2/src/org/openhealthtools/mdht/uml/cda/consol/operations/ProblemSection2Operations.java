...
public class ProblemSection2Operations extends ProblemSectionEntriesOptional2Operations {
	...
	public static boolean validateProblemSection2NullFlavor(ProblemSection2 problemSection2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PROBLEM_SECTION2_NULL_FLAVOR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(problemSection2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
	...
	public static boolean validateProblemSection2Title(ProblemSection2 problemSection2, DiagnosticChain diagnostics,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PROBLEM_SECTION2_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(problemSection2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	/**
	 * The cached OCL expression body for the '{@link #validateProblemSection2Entry1200(ProblemSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Problem Section2 Entry1200</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateProblemSection2Entry1200(ProblemSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_PROBLEM_SECTION2_ENTRY1200__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.nullFlavor <> vocab::NullFlavor::NI implies entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(cda::Entry))";

	/**
	 * The cached OCL invariant for the '{@link #validateProblemSection2Entry1200(ProblemSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Problem Section2 Entry1200</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateProblemSection2Entry1200(ProblemSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Constraint VALIDATE_PROBLEM_SECTION2_ENTRY1200__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validateProblemSection2Entry1200(ProblemSection2 problemSection2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_PROBLEM_SECTION2_ENTRY1200__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.PROBLEM_SECTION2);
			try {
				VALIDATE_PROBLEM_SECTION2_ENTRY1200__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_PROBLEM_SECTION2_ENTRY1200__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_PROBLEM_SECTION2_ENTRY1200__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(problemSection2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.PROBLEM_SECTION2__PROBLEM_SECTION2_ENTRY1200,
						 ConsolPlugin.INSTANCE.getString("ProblemSection2ProblemSection2Entry1200"),
						 new Object [] { problemSection2 }));
			}
	...
	/**
	 * The cached OCL expression body for the '{@link #validateProblemSection2Entry1202(ProblemSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Problem Section2 Entry1202</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateProblemSection2Entry1202(ProblemSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_PROBLEM_SECTION2_ENTRY1202__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.nullFlavor <> vocab::NullFlavor::NI implies entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(cda::Entry))";

	/**
	 * The cached OCL invariant for the '{@link #validateProblemSection2Entry1202(ProblemSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Problem Section2 Entry1202</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateProblemSection2Entry1202(ProblemSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Constraint VALIDATE_PROBLEM_SECTION2_ENTRY1202__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validateProblemSection2Entry1202(ProblemSection2 problemSection2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_PROBLEM_SECTION2_ENTRY1202__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.PROBLEM_SECTION2);
			try {
				VALIDATE_PROBLEM_SECTION2_ENTRY1202__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_PROBLEM_SECTION2_ENTRY1202__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_PROBLEM_SECTION2_ENTRY1202__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(problemSection2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.PROBLEM_SECTION2__PROBLEM_SECTION2_ENTRY1202,
						 ConsolPlugin.INSTANCE.getString("ProblemSection2ProblemSection2Entry1202"),
						 new Object [] { problemSection2 }));
			}
	...
	/**
	 * The cached OCL expression body for the '{@link #validateProblemSection2ProblemConcernAct2EntryProblemConcernAct21201(ProblemSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Problem Section2 Problem Concern Act2 Entry Problem Concern Act21201</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateProblemSection2ProblemConcernAct2EntryProblemConcernAct21201(ProblemSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_PROBLEM_SECTION2_PROBLEM_CONCERN_ACT2_ENTRY_PROBLEM_CONCERN_ACT21201__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->excluding(null)->reject(act->exists(act : cda::Act | not act.oclIsUndefined() and act.oclIsKindOf(consol::ProblemConcernAct2)))";

	/**
	 * The cached OCL invariant for the '{@link #validateProblemSection2ProblemConcernAct2EntryProblemConcernAct21201(ProblemSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Problem Section2 Problem Concern Act2 Entry Problem Concern Act21201</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateProblemSection2ProblemConcernAct2EntryProblemConcernAct21201(ProblemSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Query<?, ?, ?> VALIDATE_PROBLEM_SECTION2_PROBLEM_CONCERN_ACT2_ENTRY_PROBLEM_CONCERN_ACT21201__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY;
	...
	public static  boolean validateProblemSection2ProblemConcernAct2EntryProblemConcernAct21201(ProblemSection2 problemSection2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_PROBLEM_SECTION2_PROBLEM_CONCERN_ACT2_ENTRY_PROBLEM_CONCERN_ACT21201__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.PROBLEM_SECTION2);
			try {
				OCLExpression<EClassifier> oclExpression = helper.createQuery(VALIDATE_PROBLEM_SECTION2_PROBLEM_CONCERN_ACT2_ENTRY_PROBLEM_CONCERN_ACT21201__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
				VALIDATE_PROBLEM_SECTION2_PROBLEM_CONCERN_ACT2_ENTRY_PROBLEM_CONCERN_ACT21201__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = EOCL_ENV.createQuery(oclExpression);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		Object oclResult = VALIDATE_PROBLEM_SECTION2_PROBLEM_CONCERN_ACT2_ENTRY_PROBLEM_CONCERN_ACT21201__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY.evaluate(problemSection2);		
			...
			if (diagnostics != null) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.PROBLEM_SECTION2__PROBLEM_SECTION2_PROBLEM_CONCERN_ACT2_ENTRY_PROBLEM_CONCERN_ACT21201,
						 ConsolPlugin.INSTANCE.getString("ProblemSection2ProblemSection2ProblemConcernAct2EntryProblemConcernAct21201"),
						 new Object [] { eObject }));
				}
	...
	/**
	 * The cached OCL expression body for the '{@link #validateProblemSection2HealthStatusObservation2EntryHealthStatusObservation21203(ProblemSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Problem Section2 Health Status Observation2 Entry Health Status Observation21203</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateProblemSection2HealthStatusObservation2EntryHealthStatusObservation21203(ProblemSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The cached OCL invariant for the '{@link #validateProblemSection2HealthStatusObservation2EntryHealthStatusObservation21203(ProblemSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Problem Section2 Health Status Observation2 Entry Health Status Observation21203</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateProblemSection2HealthStatusObservation2EntryHealthStatusObservation21203(ProblemSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Query<?, ?, ?> VALIDATE_PROBLEM_SECTION2_HEALTH_STATUS_OBSERVATION2_ENTRY_HEALTH_STATUS_OBSERVATION21203__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY;
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static  boolean validateProblemSection2HealthStatusObservation2EntryHealthStatusObservation21203(ProblemSection2 problemSection2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_PROBLEM_SECTION2_HEALTH_STATUS_OBSERVATION2_ENTRY_HEALTH_STATUS_OBSERVATION21203__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.PROBLEM_SECTION2);
			try {
				OCLExpression<EClassifier> oclExpression = helper.createQuery(VALIDATE_PROBLEM_SECTION2_HEALTH_STATUS_OBSERVATION2_ENTRY_HEALTH_STATUS_OBSERVATION21203__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
				VALIDATE_PROBLEM_SECTION2_HEALTH_STATUS_OBSERVATION2_ENTRY_HEALTH_STATUS_OBSERVATION21203__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = EOCL_ENV.createQuery(oclExpression);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		Object oclResult = VALIDATE_PROBLEM_SECTION2_HEALTH_STATUS_OBSERVATION2_ENTRY_HEALTH_STATUS_OBSERVATION21203__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY.evaluate(problemSection2);		
		if (oclResult != null && oclResult instanceof Collection) {
			Collection<? extends EObject> oclResultSet = (Collection<? extends EObject>) oclResult;
			...
			if (diagnostics != null) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.PROBLEM_SECTION2__PROBLEM_SECTION2_HEALTH_STATUS_OBSERVATION2_ENTRY_HEALTH_STATUS_OBSERVATION21203,
						 ConsolPlugin.INSTANCE.getString("ProblemSection2ProblemSection2HealthStatusObservation2EntryHealthStatusObservation21203"),
						 new Object [] { eObject }));
				}
	...
	public static boolean validateProblemSectionEntriesOptionalTemplateId(ProblemSection2 problemSection2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PROBLEM_SECTION_ENTRIES_OPTIONAL_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(problemSection2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateProblemSectionEntriesOptionalCodeP(ProblemSection2 problemSection2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PROBLEM_SECTION_ENTRIES_OPTIONAL_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(problemSection2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
...
"value.code = '11450-4' and value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	public static boolean validateProblemSectionEntriesOptionalCode(ProblemSection2 problemSection2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PROBLEM_SECTION_ENTRIES_OPTIONAL_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(problemSection2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
