...
public class PlannedCoverageOperations extends ClinicalStatementOperations {
	...
	public static boolean validatePlannedCoverageTemplateId(PlannedCoverage plannedCoverage,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_COVERAGE_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedCoverage)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validatePlannedCoverageClassCode(PlannedCoverage plannedCoverage,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_COVERAGE_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedCoverage)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validatePlannedCoverageMoodCode(PlannedCoverage plannedCoverage, DiagnosticChain diagnostics,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_COVERAGE_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedCoverage)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_PLANNED_COVERAGE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.id->isEmpty() or self.id->exists(element | element.isNullFlavorUndefined())) implies (self.id->size() >= 1)";
	...
	public static boolean validatePlannedCoverageCodeP(PlannedCoverage plannedCoverage, DiagnosticChain diagnostics,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_COVERAGE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedCoverage)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
...
"value.code = 'active')";
	...
	public static boolean validatePlannedCoverageStatusCode(PlannedCoverage plannedCoverage,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_COVERAGE_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedCoverage)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validatePlannedCoverageStatusCodeP(PlannedCoverage plannedCoverage,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_COVERAGE_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedCoverage)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validatePlannedCoverageEntryRelationship(PlannedCoverage plannedCoverage,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_COVERAGE_ENTRY_RELATIONSHIP__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedCoverage)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validatePlannedCoverageAuthorParticipation(PlannedCoverage plannedCoverage,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_COVERAGE_AUTHOR_PARTICIPATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedCoverage)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_PLANNED_COVERAGE_ENTRY_RELATIONSHIP_ACT_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entryRelationship->excluding(null).act->excluding(null)->reject((id->isEmpty() or id->exists(element | element.isNullFlavorUndefined())) implies (id->size() >= 1))";
