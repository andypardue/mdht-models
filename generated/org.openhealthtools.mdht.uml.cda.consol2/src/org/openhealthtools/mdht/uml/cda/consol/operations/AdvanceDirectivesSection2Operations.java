...
public class AdvanceDirectivesSection2Operations extends AdvanceDirectivesSectionEntriesOptional2Operations {
	...
	public static boolean validateAdvanceDirectivesSection2HasAdvanceDirectiveObservation2XorAdvanceDirectiveOrganizer(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ADVANCE_DIRECTIVES_SECTION2_HAS_ADVANCE_DIRECTIVE_OBSERVATION2_XOR_ADVANCE_DIRECTIVE_ORGANIZER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(advanceDirectivesSection2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateAdvanceDirectivesSection2Text(AdvanceDirectivesSection2 advanceDirectivesSection2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ADVANCE_DIRECTIVES_SECTION2_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(advanceDirectivesSection2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateAdvanceDirectivesSection2Title(AdvanceDirectivesSection2 advanceDirectivesSection2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ADVANCE_DIRECTIVES_SECTION2_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(advanceDirectivesSection2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateAdvanceDirectivesSection2NullFlavor(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ADVANCE_DIRECTIVES_SECTION2_NULL_FLAVOR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(advanceDirectivesSection2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
	...
	public static boolean validateAdvanceDirectivesSection2Entry(AdvanceDirectivesSection2 advanceDirectivesSection2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ADVANCE_DIRECTIVES_SECTION2_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(advanceDirectivesSection2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	/**
	 * The cached OCL expression body for the '{@link #validateAdvanceDirectivesSection2Entry1184(AdvanceDirectivesSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Advance Directives Section2 Entry1184</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateAdvanceDirectivesSection2Entry1184(AdvanceDirectivesSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_ADVANCE_DIRECTIVES_SECTION2_ENTRY1184__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.nullFlavor <> vocab::NullFlavor::NI implies entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(cda::Entry))";

	/**
	 * The cached OCL invariant for the '{@link #validateAdvanceDirectivesSection2Entry1184(AdvanceDirectivesSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Advance Directives Section2 Entry1184</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateAdvanceDirectivesSection2Entry1184(AdvanceDirectivesSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Constraint VALIDATE_ADVANCE_DIRECTIVES_SECTION2_ENTRY1184__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validateAdvanceDirectivesSection2Entry1184(AdvanceDirectivesSection2 advanceDirectivesSection2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_ADVANCE_DIRECTIVES_SECTION2_ENTRY1184__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.ADVANCE_DIRECTIVES_SECTION2);
			try {
				VALIDATE_ADVANCE_DIRECTIVES_SECTION2_ENTRY1184__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_ADVANCE_DIRECTIVES_SECTION2_ENTRY1184__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_ADVANCE_DIRECTIVES_SECTION2_ENTRY1184__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(advanceDirectivesSection2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.ADVANCE_DIRECTIVES_SECTION2__ADVANCE_DIRECTIVES_SECTION2_ENTRY1184,
						 ConsolPlugin.INSTANCE.getString("AdvanceDirectivesSection2AdvanceDirectivesSection2Entry1184"),
						 new Object [] { advanceDirectivesSection2 }));
			}
	...
	/**
	 * The cached OCL expression body for the '{@link #validateAdvanceDirectivesSection2Entry1186(AdvanceDirectivesSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Advance Directives Section2 Entry1186</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateAdvanceDirectivesSection2Entry1186(AdvanceDirectivesSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_ADVANCE_DIRECTIVES_SECTION2_ENTRY1186__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.nullFlavor <> vocab::NullFlavor::NI implies entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(cda::Entry))";

	/**
	 * The cached OCL invariant for the '{@link #validateAdvanceDirectivesSection2Entry1186(AdvanceDirectivesSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Advance Directives Section2 Entry1186</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateAdvanceDirectivesSection2Entry1186(AdvanceDirectivesSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Constraint VALIDATE_ADVANCE_DIRECTIVES_SECTION2_ENTRY1186__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validateAdvanceDirectivesSection2Entry1186(AdvanceDirectivesSection2 advanceDirectivesSection2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_ADVANCE_DIRECTIVES_SECTION2_ENTRY1186__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.ADVANCE_DIRECTIVES_SECTION2);
			try {
				VALIDATE_ADVANCE_DIRECTIVES_SECTION2_ENTRY1186__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_ADVANCE_DIRECTIVES_SECTION2_ENTRY1186__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_ADVANCE_DIRECTIVES_SECTION2_ENTRY1186__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(advanceDirectivesSection2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.ADVANCE_DIRECTIVES_SECTION2__ADVANCE_DIRECTIVES_SECTION2_ENTRY1186,
						 ConsolPlugin.INSTANCE.getString("AdvanceDirectivesSection2AdvanceDirectivesSection2Entry1186"),
						 new Object [] { advanceDirectivesSection2 }));
			}
	...
	/**
	 * The cached OCL expression body for the '{@link #validateAdvanceDirectivesSection2AdvanceDirectiveObservation2EntryAdvanceDirectiveObservation21185(AdvanceDirectivesSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Advance Directives Section2 Advance Directive Observation2 Entry Advance Directive Observation21185</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateAdvanceDirectivesSection2AdvanceDirectiveObservation2EntryAdvanceDirectiveObservation21185(AdvanceDirectivesSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The cached OCL invariant for the '{@link #validateAdvanceDirectivesSection2AdvanceDirectiveObservation2EntryAdvanceDirectiveObservation21185(AdvanceDirectivesSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Advance Directives Section2 Advance Directive Observation2 Entry Advance Directive Observation21185</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateAdvanceDirectivesSection2AdvanceDirectiveObservation2EntryAdvanceDirectiveObservation21185(AdvanceDirectivesSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Query<?, ?, ?> VALIDATE_ADVANCE_DIRECTIVES_SECTION2_ADVANCE_DIRECTIVE_OBSERVATION2_ENTRY_ADVANCE_DIRECTIVE_OBSERVATION21185__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY;
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static  boolean validateAdvanceDirectivesSection2AdvanceDirectiveObservation2EntryAdvanceDirectiveObservation21185(AdvanceDirectivesSection2 advanceDirectivesSection2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_ADVANCE_DIRECTIVES_SECTION2_ADVANCE_DIRECTIVE_OBSERVATION2_ENTRY_ADVANCE_DIRECTIVE_OBSERVATION21185__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.ADVANCE_DIRECTIVES_SECTION2);
			try {
				OCLExpression<EClassifier> oclExpression = helper.createQuery(VALIDATE_ADVANCE_DIRECTIVES_SECTION2_ADVANCE_DIRECTIVE_OBSERVATION2_ENTRY_ADVANCE_DIRECTIVE_OBSERVATION21185__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
				VALIDATE_ADVANCE_DIRECTIVES_SECTION2_ADVANCE_DIRECTIVE_OBSERVATION2_ENTRY_ADVANCE_DIRECTIVE_OBSERVATION21185__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = EOCL_ENV.createQuery(oclExpression);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		Object oclResult = VALIDATE_ADVANCE_DIRECTIVES_SECTION2_ADVANCE_DIRECTIVE_OBSERVATION2_ENTRY_ADVANCE_DIRECTIVE_OBSERVATION21185__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY.evaluate(advanceDirectivesSection2);		
		if (oclResult != null && oclResult instanceof Collection) {
			Collection<? extends EObject> oclResultSet = (Collection<? extends EObject>) oclResult;
			...
			if (diagnostics != null) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.ADVANCE_DIRECTIVES_SECTION2__ADVANCE_DIRECTIVES_SECTION2_ADVANCE_DIRECTIVE_OBSERVATION2_ENTRY_ADVANCE_DIRECTIVE_OBSERVATION21185,
						 ConsolPlugin.INSTANCE.getString("AdvanceDirectivesSection2AdvanceDirectivesSection2AdvanceDirectiveObservation2EntryAdvanceDirectiveObservation21185"),
						 new Object [] { eObject }));
				}
	...
	/**
	 * The cached OCL expression body for the '{@link #validateAdvanceDirectivesSection2AdvanceDirectiveOrganizerEntryAdvanceDirectiveOrganizer1187(AdvanceDirectivesSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Advance Directives Section2 Advance Directive Organizer Entry Advance Directive Organizer1187</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateAdvanceDirectivesSection2AdvanceDirectiveOrganizerEntryAdvanceDirectiveOrganizer1187(AdvanceDirectivesSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_ADVANCE_DIRECTIVES_SECTION2_ADVANCE_DIRECTIVE_ORGANIZER_ENTRY_ADVANCE_DIRECTIVE_ORGANIZER1187__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->excluding(null)->reject(organizer->exists(organizer : cda::Organizer | not organizer.oclIsUndefined() and organizer.oclIsKindOf(consol::AdvanceDirectiveOrganizer)))";

	/**
	 * The cached OCL invariant for the '{@link #validateAdvanceDirectivesSection2AdvanceDirectiveOrganizerEntryAdvanceDirectiveOrganizer1187(AdvanceDirectivesSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Advance Directives Section2 Advance Directive Organizer Entry Advance Directive Organizer1187</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateAdvanceDirectivesSection2AdvanceDirectiveOrganizerEntryAdvanceDirectiveOrganizer1187(AdvanceDirectivesSection2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Query<?, ?, ?> VALIDATE_ADVANCE_DIRECTIVES_SECTION2_ADVANCE_DIRECTIVE_ORGANIZER_ENTRY_ADVANCE_DIRECTIVE_ORGANIZER1187__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY;
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static  boolean validateAdvanceDirectivesSection2AdvanceDirectiveOrganizerEntryAdvanceDirectiveOrganizer1187(AdvanceDirectivesSection2 advanceDirectivesSection2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_ADVANCE_DIRECTIVES_SECTION2_ADVANCE_DIRECTIVE_ORGANIZER_ENTRY_ADVANCE_DIRECTIVE_ORGANIZER1187__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.ADVANCE_DIRECTIVES_SECTION2);
			try {
				OCLExpression<EClassifier> oclExpression = helper.createQuery(VALIDATE_ADVANCE_DIRECTIVES_SECTION2_ADVANCE_DIRECTIVE_ORGANIZER_ENTRY_ADVANCE_DIRECTIVE_ORGANIZER1187__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
				VALIDATE_ADVANCE_DIRECTIVES_SECTION2_ADVANCE_DIRECTIVE_ORGANIZER_ENTRY_ADVANCE_DIRECTIVE_ORGANIZER1187__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = EOCL_ENV.createQuery(oclExpression);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		Object oclResult = VALIDATE_ADVANCE_DIRECTIVES_SECTION2_ADVANCE_DIRECTIVE_ORGANIZER_ENTRY_ADVANCE_DIRECTIVE_ORGANIZER1187__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY.evaluate(advanceDirectivesSection2);		
		if (oclResult != null && oclResult instanceof Collection) {
			Collection<? extends EObject> oclResultSet = (Collection<? extends EObject>) oclResult;
			...
			if (diagnostics != null) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.ADVANCE_DIRECTIVES_SECTION2__ADVANCE_DIRECTIVES_SECTION2_ADVANCE_DIRECTIVE_ORGANIZER_ENTRY_ADVANCE_DIRECTIVE_ORGANIZER1187,
						 ConsolPlugin.INSTANCE.getString("AdvanceDirectivesSection2AdvanceDirectivesSection2AdvanceDirectiveOrganizerEntryAdvanceDirectiveOrganizer1187"),
						 new Object [] { eObject }));
				}
	...
	public static boolean validateAdvanceDirectivesSectionEntriesOptionalTemplateId(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ADVANCE_DIRECTIVES_SECTION_ENTRIES_OPTIONAL_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(advanceDirectivesSection2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateAdvanceDirectivesSectionEntriesOptionalCodeP(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ADVANCE_DIRECTIVES_SECTION_ENTRIES_OPTIONAL_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(advanceDirectivesSection2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateAdvanceDirectivesSectionEntriesOptionalCode(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ADVANCE_DIRECTIVES_SECTION_ENTRIES_OPTIONAL_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(advanceDirectivesSection2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
