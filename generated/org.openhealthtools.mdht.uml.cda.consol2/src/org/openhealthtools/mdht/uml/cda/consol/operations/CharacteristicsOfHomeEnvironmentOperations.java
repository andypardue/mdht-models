...
public class CharacteristicsOfHomeEnvironmentOperations extends ClinicalStatementOperations {
	...
	public static boolean validateCharacteristicsOfHomeEnvironmentTemplateId(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_CHARACTERISTICS_OF_HOME_ENVIRONMENT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(characteristicsOfHomeEnvironment)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateCharacteristicsOfHomeEnvironmentClassCode(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_CHARACTERISTICS_OF_HOME_ENVIRONMENT_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(characteristicsOfHomeEnvironment)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateCharacteristicsOfHomeEnvironmentMoodCode(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_CHARACTERISTICS_OF_HOME_ENVIRONMENT_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(characteristicsOfHomeEnvironment)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_CHARACTERISTICS_OF_HOME_ENVIRONMENT_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.id->isEmpty() or self.id->exists(element | element.isNullFlavorUndefined())) implies (self.id->size() >= 1)";
	...
	public static boolean validateCharacteristicsOfHomeEnvironmentId(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_CHARACTERISTICS_OF_HOME_ENVIRONMENT_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(characteristicsOfHomeEnvironment)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateCharacteristicsOfHomeEnvironmentCodeP(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_CHARACTERISTICS_OF_HOME_ENVIRONMENT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(characteristicsOfHomeEnvironment)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
...
"value.code = '75274-1' and value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	public static boolean validateCharacteristicsOfHomeEnvironmentCode(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_CHARACTERISTICS_OF_HOME_ENVIRONMENT_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(characteristicsOfHomeEnvironment)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
...
"value.code = 'completed')";
	...
	public static boolean validateCharacteristicsOfHomeEnvironmentStatusCode(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_CHARACTERISTICS_OF_HOME_ENVIRONMENT_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(characteristicsOfHomeEnvironment)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateCharacteristicsOfHomeEnvironmentStatusCodeP(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_CHARACTERISTICS_OF_HOME_ENVIRONMENT_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(characteristicsOfHomeEnvironment)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
...
"value.codeSystem = '2.16.840.1.113883.6.96' and not value.code.oclIsUndefined()))";
	...
	public static boolean validateCharacteristicsOfHomeEnvironmentValue(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_CHARACTERISTICS_OF_HOME_ENVIRONMENT_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(characteristicsOfHomeEnvironment)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
	...
	public static boolean validateCharacteristicsOfHomeEnvironmentValueP(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_CHARACTERISTICS_OF_HOME_ENVIRONMENT_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(characteristicsOfHomeEnvironment)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
