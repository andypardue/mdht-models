...
"value.code = '77386006' and value.codeSystem = '2.16.840.1.113883.6.96'))";
	...
	/**
	 * The cached OCL expression body for the '{@link #validatePregnancyObservationEntryRelationship148(PregnancyObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Pregnancy Observation Entry Relationship148</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePregnancyObservationEntryRelationship148(PregnancyObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_PREGNANCY_OBSERVATION_ENTRY_RELATIONSHIP148__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entryRelationship->one(entryRelationship : cda::EntryRelationship | not entryRelationship.oclIsUndefined() and entryRelationship.oclIsKindOf(cda::EntryRelationship))";

	/**
	 * The cached OCL invariant for the '{@link #validatePregnancyObservationEntryRelationship148(PregnancyObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Pregnancy Observation Entry Relationship148</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePregnancyObservationEntryRelationship148(PregnancyObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Constraint VALIDATE_PREGNANCY_OBSERVATION_ENTRY_RELATIONSHIP148__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validatePregnancyObservationEntryRelationship148(PregnancyObservation pregnancyObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_PREGNANCY_OBSERVATION_ENTRY_RELATIONSHIP148__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.PREGNANCY_OBSERVATION);
			try {
				VALIDATE_PREGNANCY_OBSERVATION_ENTRY_RELATIONSHIP148__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_PREGNANCY_OBSERVATION_ENTRY_RELATIONSHIP148__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_PREGNANCY_OBSERVATION_ENTRY_RELATIONSHIP148__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(pregnancyObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.PREGNANCY_OBSERVATION__PREGNANCY_OBSERVATION_ENTRY_RELATIONSHIP148,
						 ConsolPlugin.INSTANCE.getString("PregnancyObservationPregnancyObservationEntryRelationship148"),
						 new Object [] { pregnancyObservation }));
			}
	...
	/**
	 * The cached OCL expression body for the '{@link #validatePregnancyObservationEstimatedDateOfDeliveryEntryRelationshipEstimatedDateOfDelivery149(PregnancyObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Pregnancy Observation Estimated Date Of Delivery Entry Relationship Estimated Date Of Delivery149</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePregnancyObservationEstimatedDateOfDeliveryEntryRelationshipEstimatedDateOfDelivery149(PregnancyObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_PREGNANCY_OBSERVATION_ESTIMATED_DATE_OF_DELIVERY_ENTRY_RELATIONSHIP_ESTIMATED_DATE_OF_DELIVERY149__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entryRelationship->excluding(null)->reject(observation->one(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(consol::EstimatedDateOfDelivery)))";

	/**
	 * The cached OCL invariant for the '{@link #validatePregnancyObservationEstimatedDateOfDeliveryEntryRelationshipEstimatedDateOfDelivery149(PregnancyObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Pregnancy Observation Estimated Date Of Delivery Entry Relationship Estimated Date Of Delivery149</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePregnancyObservationEstimatedDateOfDeliveryEntryRelationshipEstimatedDateOfDelivery149(PregnancyObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Query<?, ?, ?> VALIDATE_PREGNANCY_OBSERVATION_ESTIMATED_DATE_OF_DELIVERY_ENTRY_RELATIONSHIP_ESTIMATED_DATE_OF_DELIVERY149__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY;
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static  boolean validatePregnancyObservationEstimatedDateOfDeliveryEntryRelationshipEstimatedDateOfDelivery149(PregnancyObservation pregnancyObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_PREGNANCY_OBSERVATION_ESTIMATED_DATE_OF_DELIVERY_ENTRY_RELATIONSHIP_ESTIMATED_DATE_OF_DELIVERY149__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.PREGNANCY_OBSERVATION);
			try {
				OCLExpression<EClassifier> oclExpression = helper.createQuery(VALIDATE_PREGNANCY_OBSERVATION_ESTIMATED_DATE_OF_DELIVERY_ENTRY_RELATIONSHIP_ESTIMATED_DATE_OF_DELIVERY149__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
				VALIDATE_PREGNANCY_OBSERVATION_ESTIMATED_DATE_OF_DELIVERY_ENTRY_RELATIONSHIP_ESTIMATED_DATE_OF_DELIVERY149__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = EOCL_ENV.createQuery(oclExpression);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		Object oclResult = VALIDATE_PREGNANCY_OBSERVATION_ESTIMATED_DATE_OF_DELIVERY_ENTRY_RELATIONSHIP_ESTIMATED_DATE_OF_DELIVERY149__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY.evaluate(pregnancyObservation);		
			...
			if (diagnostics != null) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.PREGNANCY_OBSERVATION__PREGNANCY_OBSERVATION_ESTIMATED_DATE_OF_DELIVERY_ENTRY_RELATIONSHIP_ESTIMATED_DATE_OF_DELIVERY149,
						 ConsolPlugin.INSTANCE.getString("PregnancyObservationPregnancyObservationEstimatedDateOfDeliveryEntryRelationshipEstimatedDateOfDelivery149"),
						 new Object [] { eObject }));
				}
