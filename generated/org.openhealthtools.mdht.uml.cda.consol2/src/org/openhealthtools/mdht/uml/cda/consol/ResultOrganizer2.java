 ...
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/consolResultOrganizer2ResultObservation2EntryRelationship constraints.validation.error='ResultOrganizer2ResultObservation2EntryRelationshipResultObservation21043'"
 * @generated
 */
public interface ResultOrganizer2 extends ResultOrganizer {
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.->reject(observation->exists(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(consol::ResultObservation2)))'"
	 * @generated
	 */
	boolean validateResultOrganizer2ResultObservation2EntryRelationshipResultObservation21043(DiagnosticChain diagnostics, Map<Object, Object> context);
