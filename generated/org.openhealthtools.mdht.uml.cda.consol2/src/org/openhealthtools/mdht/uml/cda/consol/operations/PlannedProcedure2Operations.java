...
public class PlannedProcedure2Operations extends PlanOfCareActivityProcedureOperations {
	...
	public static boolean validatePlannedProcedure2CodeFromLoincOrSnomed(PlannedProcedure2 plannedProcedure2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_PROCEDURE2_CODE_FROM_LOINC_OR_SNOMED__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedProcedure2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
	...
	public static boolean validatePlannedProcedure2CodeFromCptOrIcd(PlannedProcedure2 plannedProcedure2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_PROCEDURE2_CODE_FROM_CPT_OR_ICD__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedProcedure2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
	...
	public static boolean validatePlannedProcedure2Instruction2InversionInd(PlannedProcedure2 plannedProcedure2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_PROCEDURE2_INSTRUCTION2_INVERSION_IND__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedProcedure2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validatePlannedProcedure2Code(PlannedProcedure2 plannedProcedure2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_PROCEDURE2_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedProcedure2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
...
"value.code = 'active')";
	...
	public static boolean validatePlannedProcedure2StatusCode(PlannedProcedure2 plannedProcedure2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_PROCEDURE2_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedProcedure2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validatePlannedProcedure2StatusCodeP(PlannedProcedure2 plannedProcedure2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_PROCEDURE2_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedProcedure2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validatePlannedProcedure2EffectiveTime(PlannedProcedure2 plannedProcedure2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_PROCEDURE2_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedProcedure2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
	...
	public static boolean validatePlannedProcedure2MethodCode(PlannedProcedure2 plannedProcedure2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_PROCEDURE2_METHOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedProcedure2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
	...
	public static boolean validatePlannedProcedure2TargetSiteCodeP(PlannedProcedure2 plannedProcedure2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_PROCEDURE2_TARGET_SITE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedProcedure2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
...
"value.codeSystem = '2.16.840.1.113883.6.96' and not value.code.oclIsUndefined()))";
	...
	public static boolean validatePlannedProcedure2TargetSiteCode(PlannedProcedure2 plannedProcedure2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_PROCEDURE2_TARGET_SITE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedProcedure2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validatePlannedProcedure2Performer(PlannedProcedure2 plannedProcedure2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_PROCEDURE2_PERFORMER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedProcedure2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
	...
	public static boolean validatePlannedProcedure2AuthorParticipation(PlannedProcedure2 plannedProcedure2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_PROCEDURE2_AUTHOR_PARTICIPATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedProcedure2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
	...
	/**
	 * The cached OCL expression body for the '{@link #validatePlannedProcedure2EntryRelationship976(PlannedProcedure2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Planned Procedure2 Entry Relationship976</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePlannedProcedure2EntryRelationship976(PlannedProcedure2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_PLANNED_PROCEDURE2_ENTRY_RELATIONSHIP976__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entryRelationship->one(entryRelationship : cda::EntryRelationship | not entryRelationship.oclIsUndefined() and entryRelationship.oclIsKindOf(cda::EntryRelationship))";

	/**
	 * The cached OCL invariant for the '{@link #validatePlannedProcedure2EntryRelationship976(PlannedProcedure2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Planned Procedure2 Entry Relationship976</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePlannedProcedure2EntryRelationship976(PlannedProcedure2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Constraint VALIDATE_PLANNED_PROCEDURE2_ENTRY_RELATIONSHIP976__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validatePlannedProcedure2EntryRelationship976(PlannedProcedure2 plannedProcedure2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_PLANNED_PROCEDURE2_ENTRY_RELATIONSHIP976__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.PLANNED_PROCEDURE2);
			try {
				VALIDATE_PLANNED_PROCEDURE2_ENTRY_RELATIONSHIP976__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_PLANNED_PROCEDURE2_ENTRY_RELATIONSHIP976__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_PROCEDURE2_ENTRY_RELATIONSHIP976__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedProcedure2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.PLANNED_PROCEDURE2__PLANNED_PROCEDURE2_ENTRY_RELATIONSHIP976,
						 ConsolPlugin.INSTANCE.getString("PlannedProcedure2PlannedProcedure2EntryRelationship976"),
						 new Object [] { plannedProcedure2 }));
			}
	...
	/**
	 * The cached OCL expression body for the '{@link #validatePlannedProcedure2EntryRelationship978(PlannedProcedure2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Planned Procedure2 Entry Relationship978</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePlannedProcedure2EntryRelationship978(PlannedProcedure2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_PLANNED_PROCEDURE2_ENTRY_RELATIONSHIP978__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entryRelationship->one(entryRelationship : cda::EntryRelationship | not entryRelationship.oclIsUndefined() and entryRelationship.oclIsKindOf(cda::EntryRelationship))";

	/**
	 * The cached OCL invariant for the '{@link #validatePlannedProcedure2EntryRelationship978(PlannedProcedure2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Planned Procedure2 Entry Relationship978</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePlannedProcedure2EntryRelationship978(PlannedProcedure2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Constraint VALIDATE_PLANNED_PROCEDURE2_ENTRY_RELATIONSHIP978__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validatePlannedProcedure2EntryRelationship978(PlannedProcedure2 plannedProcedure2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_PLANNED_PROCEDURE2_ENTRY_RELATIONSHIP978__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.PLANNED_PROCEDURE2);
			try {
				VALIDATE_PLANNED_PROCEDURE2_ENTRY_RELATIONSHIP978__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_PLANNED_PROCEDURE2_ENTRY_RELATIONSHIP978__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_PROCEDURE2_ENTRY_RELATIONSHIP978__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedProcedure2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.PLANNED_PROCEDURE2__PLANNED_PROCEDURE2_ENTRY_RELATIONSHIP978,
						 ConsolPlugin.INSTANCE.getString("PlannedProcedure2PlannedProcedure2EntryRelationship978"),
						 new Object [] { plannedProcedure2 }));
			}
	...
	/**
	 * The cached OCL expression body for the '{@link #validatePlannedProcedure2EntryRelationship980(PlannedProcedure2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Planned Procedure2 Entry Relationship980</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePlannedProcedure2EntryRelationship980(PlannedProcedure2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_PLANNED_PROCEDURE2_ENTRY_RELATIONSHIP980__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entryRelationship->one(entryRelationship : cda::EntryRelationship | not entryRelationship.oclIsUndefined() and entryRelationship.oclIsKindOf(cda::EntryRelationship))";

	/**
	 * The cached OCL invariant for the '{@link #validatePlannedProcedure2EntryRelationship980(PlannedProcedure2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Planned Procedure2 Entry Relationship980</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePlannedProcedure2EntryRelationship980(PlannedProcedure2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Constraint VALIDATE_PLANNED_PROCEDURE2_ENTRY_RELATIONSHIP980__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validatePlannedProcedure2EntryRelationship980(PlannedProcedure2 plannedProcedure2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_PLANNED_PROCEDURE2_ENTRY_RELATIONSHIP980__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.PLANNED_PROCEDURE2);
			try {
				VALIDATE_PLANNED_PROCEDURE2_ENTRY_RELATIONSHIP980__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_PLANNED_PROCEDURE2_ENTRY_RELATIONSHIP980__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_PROCEDURE2_ENTRY_RELATIONSHIP980__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedProcedure2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.PLANNED_PROCEDURE2__PLANNED_PROCEDURE2_ENTRY_RELATIONSHIP980,
						 ConsolPlugin.INSTANCE.getString("PlannedProcedure2PlannedProcedure2EntryRelationship980"),
						 new Object [] { plannedProcedure2 }));
			}
	...
	/**
	 * The cached OCL expression body for the '{@link #validatePlannedProcedure2EntryRelationship982(PlannedProcedure2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Planned Procedure2 Entry Relationship982</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePlannedProcedure2EntryRelationship982(PlannedProcedure2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_PLANNED_PROCEDURE2_ENTRY_RELATIONSHIP982__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entryRelationship->one(entryRelationship : cda::EntryRelationship | not entryRelationship.oclIsUndefined() and entryRelationship.oclIsKindOf(cda::EntryRelationship))";

	/**
	 * The cached OCL invariant for the '{@link #validatePlannedProcedure2EntryRelationship982(PlannedProcedure2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Planned Procedure2 Entry Relationship982</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePlannedProcedure2EntryRelationship982(PlannedProcedure2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Constraint VALIDATE_PLANNED_PROCEDURE2_ENTRY_RELATIONSHIP982__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validatePlannedProcedure2EntryRelationship982(PlannedProcedure2 plannedProcedure2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_PLANNED_PROCEDURE2_ENTRY_RELATIONSHIP982__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.PLANNED_PROCEDURE2);
			try {
				VALIDATE_PLANNED_PROCEDURE2_ENTRY_RELATIONSHIP982__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_PLANNED_PROCEDURE2_ENTRY_RELATIONSHIP982__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_PROCEDURE2_ENTRY_RELATIONSHIP982__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedProcedure2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.PLANNED_PROCEDURE2__PLANNED_PROCEDURE2_ENTRY_RELATIONSHIP982,
						 ConsolPlugin.INSTANCE.getString("PlannedProcedure2PlannedProcedure2EntryRelationship982"),
						 new Object [] { plannedProcedure2 }));
			}
	...
	/**
	 * The cached OCL expression body for the '{@link #validatePlannedProcedure2PriorityPreferenceEntryRelationshipPriorityPreference977(PlannedProcedure2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Planned Procedure2 Priority Preference Entry Relationship Priority Preference977</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePlannedProcedure2PriorityPreferenceEntryRelationshipPriorityPreference977(PlannedProcedure2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The cached OCL invariant for the '{@link #validatePlannedProcedure2PriorityPreferenceEntryRelationshipPriorityPreference977(PlannedProcedure2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Planned Procedure2 Priority Preference Entry Relationship Priority Preference977</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePlannedProcedure2PriorityPreferenceEntryRelationshipPriorityPreference977(PlannedProcedure2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Query<?, ?, ?> VALIDATE_PLANNED_PROCEDURE2_PRIORITY_PREFERENCE_ENTRY_RELATIONSHIP_PRIORITY_PREFERENCE977__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY;
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static  boolean validatePlannedProcedure2PriorityPreferenceEntryRelationshipPriorityPreference977(PlannedProcedure2 plannedProcedure2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_PLANNED_PROCEDURE2_PRIORITY_PREFERENCE_ENTRY_RELATIONSHIP_PRIORITY_PREFERENCE977__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.PLANNED_PROCEDURE2);
			try {
				OCLExpression<EClassifier> oclExpression = helper.createQuery(VALIDATE_PLANNED_PROCEDURE2_PRIORITY_PREFERENCE_ENTRY_RELATIONSHIP_PRIORITY_PREFERENCE977__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
				VALIDATE_PLANNED_PROCEDURE2_PRIORITY_PREFERENCE_ENTRY_RELATIONSHIP_PRIORITY_PREFERENCE977__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = EOCL_ENV.createQuery(oclExpression);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		Object oclResult = VALIDATE_PLANNED_PROCEDURE2_PRIORITY_PREFERENCE_ENTRY_RELATIONSHIP_PRIORITY_PREFERENCE977__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY.evaluate(plannedProcedure2);		
			...
			if (diagnostics != null) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.PLANNED_PROCEDURE2__PLANNED_PROCEDURE2_PRIORITY_PREFERENCE_ENTRY_RELATIONSHIP_PRIORITY_PREFERENCE977,
						 ConsolPlugin.INSTANCE.getString("PlannedProcedure2PlannedProcedure2PriorityPreferenceEntryRelationshipPriorityPreference977"),
						 new Object [] { eObject }));
				}
	...
	/**
	 * The cached OCL expression body for the '{@link #validatePlannedProcedure2Indication2EntryRelationshipIndication2979(PlannedProcedure2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Planned Procedure2 Indication2 Entry Relationship Indication2979</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePlannedProcedure2Indication2EntryRelationshipIndication2979(PlannedProcedure2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_PLANNED_PROCEDURE2_INDICATION2_ENTRY_RELATIONSHIP_INDICATION2979__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entryRelationship->excluding(null)->reject(observation->exists(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(consol::Indication2)))";

	/**
	 * The cached OCL invariant for the '{@link #validatePlannedProcedure2Indication2EntryRelationshipIndication2979(PlannedProcedure2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Planned Procedure2 Indication2 Entry Relationship Indication2979</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePlannedProcedure2Indication2EntryRelationshipIndication2979(PlannedProcedure2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Query<?, ?, ?> VALIDATE_PLANNED_PROCEDURE2_INDICATION2_ENTRY_RELATIONSHIP_INDICATION2979__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY;
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static  boolean validatePlannedProcedure2Indication2EntryRelationshipIndication2979(PlannedProcedure2 plannedProcedure2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_PLANNED_PROCEDURE2_INDICATION2_ENTRY_RELATIONSHIP_INDICATION2979__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.PLANNED_PROCEDURE2);
			try {
				OCLExpression<EClassifier> oclExpression = helper.createQuery(VALIDATE_PLANNED_PROCEDURE2_INDICATION2_ENTRY_RELATIONSHIP_INDICATION2979__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
				VALIDATE_PLANNED_PROCEDURE2_INDICATION2_ENTRY_RELATIONSHIP_INDICATION2979__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = EOCL_ENV.createQuery(oclExpression);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		Object oclResult = VALIDATE_PLANNED_PROCEDURE2_INDICATION2_ENTRY_RELATIONSHIP_INDICATION2979__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY.evaluate(plannedProcedure2);		
		if (oclResult != null && oclResult instanceof Collection) {
			Collection<? extends EObject> oclResultSet = (Collection<? extends EObject>) oclResult;
			...
			if (diagnostics != null) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.PLANNED_PROCEDURE2__PLANNED_PROCEDURE2_INDICATION2_ENTRY_RELATIONSHIP_INDICATION2979,
						 ConsolPlugin.INSTANCE.getString("PlannedProcedure2PlannedProcedure2Indication2EntryRelationshipIndication2979"),
						 new Object [] { eObject }));
				}
	...
	/**
	 * The cached OCL expression body for the '{@link #validatePlannedProcedure2Instruction2EntryRelationshipInstruction2981(PlannedProcedure2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Planned Procedure2 Instruction2 Entry Relationship Instruction2981</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePlannedProcedure2Instruction2EntryRelationshipInstruction2981(PlannedProcedure2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_PLANNED_PROCEDURE2_INSTRUCTION2_ENTRY_RELATIONSHIP_INSTRUCTION2981__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entryRelationship->excluding(null)->reject(act->exists(act : cda::Act | not act.oclIsUndefined() and act.oclIsKindOf(consol::Instruction2)))";

	/**
	 * The cached OCL invariant for the '{@link #validatePlannedProcedure2Instruction2EntryRelationshipInstruction2981(PlannedProcedure2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Planned Procedure2 Instruction2 Entry Relationship Instruction2981</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePlannedProcedure2Instruction2EntryRelationshipInstruction2981(PlannedProcedure2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Query<?, ?, ?> VALIDATE_PLANNED_PROCEDURE2_INSTRUCTION2_ENTRY_RELATIONSHIP_INSTRUCTION2981__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY;
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static  boolean validatePlannedProcedure2Instruction2EntryRelationshipInstruction2981(PlannedProcedure2 plannedProcedure2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_PLANNED_PROCEDURE2_INSTRUCTION2_ENTRY_RELATIONSHIP_INSTRUCTION2981__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.PLANNED_PROCEDURE2);
			try {
				OCLExpression<EClassifier> oclExpression = helper.createQuery(VALIDATE_PLANNED_PROCEDURE2_INSTRUCTION2_ENTRY_RELATIONSHIP_INSTRUCTION2981__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
				VALIDATE_PLANNED_PROCEDURE2_INSTRUCTION2_ENTRY_RELATIONSHIP_INSTRUCTION2981__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = EOCL_ENV.createQuery(oclExpression);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		Object oclResult = VALIDATE_PLANNED_PROCEDURE2_INSTRUCTION2_ENTRY_RELATIONSHIP_INSTRUCTION2981__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY.evaluate(plannedProcedure2);		
		if (oclResult != null && oclResult instanceof Collection) {
			Collection<? extends EObject> oclResultSet = (Collection<? extends EObject>) oclResult;
			...
			if (diagnostics != null) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.PLANNED_PROCEDURE2__PLANNED_PROCEDURE2_INSTRUCTION2_ENTRY_RELATIONSHIP_INSTRUCTION2981,
						 ConsolPlugin.INSTANCE.getString("PlannedProcedure2PlannedProcedure2Instruction2EntryRelationshipInstruction2981"),
						 new Object [] { eObject }));
				}
	...
	/**
	 * The cached OCL expression body for the '{@link #validatePlannedProcedure2PlannedCoverageEntryRelationshipPlannedCoverage983(PlannedProcedure2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Planned Procedure2 Planned Coverage Entry Relationship Planned Coverage983</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePlannedProcedure2PlannedCoverageEntryRelationshipPlannedCoverage983(PlannedProcedure2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_PLANNED_PROCEDURE2_PLANNED_COVERAGE_ENTRY_RELATIONSHIP_PLANNED_COVERAGE983__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entryRelationship->excluding(null)->reject(act->exists(act : cda::Act | not act.oclIsUndefined() and act.oclIsKindOf(consol::PlannedCoverage)))";

	/**
	 * The cached OCL invariant for the '{@link #validatePlannedProcedure2PlannedCoverageEntryRelationshipPlannedCoverage983(PlannedProcedure2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Planned Procedure2 Planned Coverage Entry Relationship Planned Coverage983</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePlannedProcedure2PlannedCoverageEntryRelationshipPlannedCoverage983(PlannedProcedure2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Query<?, ?, ?> VALIDATE_PLANNED_PROCEDURE2_PLANNED_COVERAGE_ENTRY_RELATIONSHIP_PLANNED_COVERAGE983__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY;
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static  boolean validatePlannedProcedure2PlannedCoverageEntryRelationshipPlannedCoverage983(PlannedProcedure2 plannedProcedure2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_PLANNED_PROCEDURE2_PLANNED_COVERAGE_ENTRY_RELATIONSHIP_PLANNED_COVERAGE983__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.PLANNED_PROCEDURE2);
			try {
				OCLExpression<EClassifier> oclExpression = helper.createQuery(VALIDATE_PLANNED_PROCEDURE2_PLANNED_COVERAGE_ENTRY_RELATIONSHIP_PLANNED_COVERAGE983__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
				VALIDATE_PLANNED_PROCEDURE2_PLANNED_COVERAGE_ENTRY_RELATIONSHIP_PLANNED_COVERAGE983__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = EOCL_ENV.createQuery(oclExpression);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		Object oclResult = VALIDATE_PLANNED_PROCEDURE2_PLANNED_COVERAGE_ENTRY_RELATIONSHIP_PLANNED_COVERAGE983__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY.evaluate(plannedProcedure2);		
		if (oclResult != null && oclResult instanceof Collection) {
			Collection<? extends EObject> oclResultSet = (Collection<? extends EObject>) oclResult;
			...
			if (diagnostics != null) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.PLANNED_PROCEDURE2__PLANNED_PROCEDURE2_PLANNED_COVERAGE_ENTRY_RELATIONSHIP_PLANNED_COVERAGE983,
						 ConsolPlugin.INSTANCE.getString("PlannedProcedure2PlannedProcedure2PlannedCoverageEntryRelationshipPlannedCoverage983"),
						 new Object [] { eObject }));
				}
	...
	public static boolean validatePlanOfCareActivityProcedureTemplateId(PlannedProcedure2 plannedProcedure2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLAN_OF_CARE_ACTIVITY_PROCEDURE_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedProcedure2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
...
"value = vocab::x_DocumentProcedureMood::INT or value = vocab::x_DocumentProcedureMood::ARQ or value = vocab::x_DocumentProcedureMood::PRMS or value = vocab::x_DocumentProcedureMood::PRP or value = vocab::x_DocumentProcedureMood::RQO";
	...
	public static boolean validatePlanOfCareActivityProcedureMoodCode(PlannedProcedure2 plannedProcedure2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLAN_OF_CARE_ACTIVITY_PROCEDURE_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedProcedure2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
