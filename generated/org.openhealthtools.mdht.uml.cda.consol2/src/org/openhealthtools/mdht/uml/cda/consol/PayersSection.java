 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='PayersSectionTemplateId PayersSectionCode PayersSectionCodeP PayersSectionTitle PayersSectionText PayersSectionEntry130' templateId.root='2.16.840.1.113883.10.20.22.2.18' code.code='48768-6' code.codeSystem='2.16.840.1.113883.6.1' code.codeSystemName='LOINC' code.displayName='Payers' constraints.validation.warning='PayersSectionCoverageActivityEntryCoverageActivity131' constraints.validation.query='PayersSectionCoverageActivityEntryCoverageActivity131'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/consolPayersSectionCoverageActivityEntry constraints.validation.warning='PayersSectionCoverageActivityEntryCoverageActivity131'"
 * @generated
 */
public interface PayersSection extends Section {
	...
	* <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	boolean validatePayersSectionEntry130(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.entry->excluding(null)->reject(act->exists(act : cda::Act | not act.oclIsUndefined() and act.oclIsKindOf(consol::CoverageActivity)))'"
	 * @generated
	 */
	boolean validatePayersSectionCoverageActivityEntryCoverageActivity131(DiagnosticChain diagnostics, Map<Object, Object> context);
