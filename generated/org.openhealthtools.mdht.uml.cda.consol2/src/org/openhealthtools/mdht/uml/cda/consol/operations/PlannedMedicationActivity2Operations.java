...
"value.code = 'active')";
	...
	public static boolean validatePlannedMedicationActivity2StatusCode(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_MEDICATION_ACTIVITY2_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedMedicationActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validatePlannedMedicationActivity2StatusCodeP(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_MEDICATION_ACTIVITY2_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedMedicationActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validatePlannedMedicationActivity2EffectiveTime(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_MEDICATION_ACTIVITY2_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedMedicationActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validatePlannedMedicationActivity2RepeatNumber(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_MEDICATION_ACTIVITY2_REPEAT_NUMBER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedMedicationActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
	...
	public static boolean validatePlannedMedicationActivity2RouteCodeP(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_MEDICATION_ACTIVITY2_ROUTE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedMedicationActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
...
"value.codeSystem = '2.16.840.1.113883.3.26.1.1' and (value.code = 'C38192' or value.code = 'C38193' or value.code = 'C38194' or value.code = 'C38675' or value.code = 'C38197' or value.code = 'C38633' or value.code = 'C38205' or value.code = 'C38206' or value.code = 'C38208' or value.code = 'C38209' or value.code = 'C38210' or value.code = 'C38211' or value.code = 'C38212' or value.code = 'C38200' or value.code = 'C38215' or value.code = 'C38219' or value.code = 'C38220' or value.code = 'C38221' or value.code = 'C38222' or value.code = 'C38223' or value.code = 'C38224' or value.code = 'C38225' or value.code = 'C38226' or value.code = 'C38227' or value.code = 'C38228' or value.code = 'C38229' or value.code = 'C38230' or value.code = 'C38231' or value.code = 'C38232' or value.code = 'C38233' or value.code = 'C38234' or value.code = 'C38217' or value.code = 'C38218' or value.code = 'C38235' or value.code = 'C38238' or value.code = 'C38239' or value.code = 'C38240' or value.code = 'C38241' or value.code = 'C38242' or value.code = 'C38243' or value.code = 'C38245' or value.code = 'C38246' or value.code = 'C38247' or value.code = 'C38249' or value.code = 'C38250' or value.code = 'C38251' or value.code = 'C38252' or value.code = 'C38253' or value.code = 'C38254' or value.code = 'C28161' or value.code = 'C38255' or value.code = 'C38256' or value.code = 'C38257' or value.code = 'C38258' or value.code = 'C38259' or value.code = 'C38260' or value.code = 'C38261' or value.code = 'C38262' or value.code = 'C38263' or value.code = 'C38264' or value.code = 'C38265' or value.code = 'C38266' or value.code = 'C38267' or value.code = 'C38207' or value.code = 'C38268' or value.code = 'C38269' or value.code = 'C38270' or value.code = 'C38272' or value.code = 'C38273' or value.code = 'C38276' or value.code = 'C38277' or value.code = 'C38278' or value.code = 'C38280' or value.code = 'C38203' or value.code = 'C38281' or value.code = 'C38282' or value.code = 'C38284' or value.code = 'C38285' or value.code = 'C48623' or value.code = 'C38286' or value.code = 'C38287' or value.code = 'C38288' or value.code = 'C38289' or value.code = 'C38291' or value.code = 'C38676' or value.code = 'C38292' or value.code = 'C38677' or value.code = 'C38293' or value.code = 'C38294' or value.code = 'C38295' or value.code = 'C38216' or value.code = 'C38296' or value.code = 'C38198' or value.code = 'C38297' or value.code = 'C38298' or value.code = 'C38299' or value.code = 'C38300' or value.code = 'C38301' or value.code = 'C38304' or value.code = 'C38305' or value.code = 'C38283' or value.code = 'C38307' or value.code = 'C38308' or value.code = 'C38309' or value.code = 'C38312' or value.code = 'C38271'))";
	...
	public static boolean validatePlannedMedicationActivity2RouteCode(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_MEDICATION_ACTIVITY2_ROUTE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedMedicationActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validatePlannedMedicationActivity2ApproachSiteCodeP(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_MEDICATION_ACTIVITY2_APPROACH_SITE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedMedicationActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
...
"value.codeSystem = '2.16.840.1.113883.6.96' and not value.code.oclIsUndefined()))";
	...
	public static boolean validatePlannedMedicationActivity2ApproachSiteCode(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_MEDICATION_ACTIVITY2_APPROACH_SITE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedMedicationActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validatePlannedMedicationActivity2DoseQuantity(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_MEDICATION_ACTIVITY2_DOSE_QUANTITY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedMedicationActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
	...
	public static boolean validatePlannedMedicationActivity2RateQuantity(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_MEDICATION_ACTIVITY2_RATE_QUANTITY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedMedicationActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
	...
	public static boolean validatePlannedMedicationActivity2MaxDoseQuantity(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_MEDICATION_ACTIVITY2_MAX_DOSE_QUANTITY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedMedicationActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
	...
	public static boolean validatePlannedMedicationActivity2AdministrationUnitCodeP(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_MEDICATION_ACTIVITY2_ADMINISTRATION_UNIT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedMedicationActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
...
"value.code = 'APPFUL' or value.code = 'DROP' or value.code = 'NDROP' or value.code = 'OPDROP' or value.code = 'ORDROP' or value.code = 'OTDROP' or value.code = 'PUFF' or value.code = 'SCOOP' or value.code = 'SPRY')";
	...
	public static boolean validatePlannedMedicationActivity2AdministrationUnitCode(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_MEDICATION_ACTIVITY2_ADMINISTRATION_UNIT_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedMedicationActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validatePlannedMedicationActivity2Performer(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_MEDICATION_ACTIVITY2_PERFORMER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedMedicationActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
	...
	public static boolean validatePlannedMedicationActivity2AuthorParticipation(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_MEDICATION_ACTIVITY2_AUTHOR_PARTICIPATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedMedicationActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
	...
	public static boolean validatePlannedMedicationActivity2Consumable(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_MEDICATION_ACTIVITY2_CONSUMABLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedMedicationActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validatePlannedMedicationActivity2Precondition(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_MEDICATION_ACTIVITY2_PRECONDITION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedMedicationActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
	...
	/**
	 * The cached OCL expression body for the '{@link #validatePlannedMedicationActivity2EntryRelationship984(PlannedMedicationActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Planned Medication Activity2 Entry Relationship984</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePlannedMedicationActivity2EntryRelationship984(PlannedMedicationActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_PLANNED_MEDICATION_ACTIVITY2_ENTRY_RELATIONSHIP984__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entryRelationship->one(entryRelationship : cda::EntryRelationship | not entryRelationship.oclIsUndefined() and entryRelationship.oclIsKindOf(cda::EntryRelationship))";

	/**
	 * The cached OCL invariant for the '{@link #validatePlannedMedicationActivity2EntryRelationship984(PlannedMedicationActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Planned Medication Activity2 Entry Relationship984</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePlannedMedicationActivity2EntryRelationship984(PlannedMedicationActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Constraint VALIDATE_PLANNED_MEDICATION_ACTIVITY2_ENTRY_RELATIONSHIP984__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validatePlannedMedicationActivity2EntryRelationship984(PlannedMedicationActivity2 plannedMedicationActivity2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_PLANNED_MEDICATION_ACTIVITY2_ENTRY_RELATIONSHIP984__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.PLANNED_MEDICATION_ACTIVITY2);
			try {
				VALIDATE_PLANNED_MEDICATION_ACTIVITY2_ENTRY_RELATIONSHIP984__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_PLANNED_MEDICATION_ACTIVITY2_ENTRY_RELATIONSHIP984__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_MEDICATION_ACTIVITY2_ENTRY_RELATIONSHIP984__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedMedicationActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.PLANNED_MEDICATION_ACTIVITY2__PLANNED_MEDICATION_ACTIVITY2_ENTRY_RELATIONSHIP984,
						 ConsolPlugin.INSTANCE.getString("PlannedMedicationActivity2PlannedMedicationActivity2EntryRelationship984"),
						 new Object [] { plannedMedicationActivity2 }));
			}
	...
	/**
	 * The cached OCL expression body for the '{@link #validatePlannedMedicationActivity2EntryRelationship986(PlannedMedicationActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Planned Medication Activity2 Entry Relationship986</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePlannedMedicationActivity2EntryRelationship986(PlannedMedicationActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_PLANNED_MEDICATION_ACTIVITY2_ENTRY_RELATIONSHIP986__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entryRelationship->one(entryRelationship : cda::EntryRelationship | not entryRelationship.oclIsUndefined() and entryRelationship.oclIsKindOf(cda::EntryRelationship))";

	/**
	 * The cached OCL invariant for the '{@link #validatePlannedMedicationActivity2EntryRelationship986(PlannedMedicationActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Planned Medication Activity2 Entry Relationship986</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePlannedMedicationActivity2EntryRelationship986(PlannedMedicationActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Constraint VALIDATE_PLANNED_MEDICATION_ACTIVITY2_ENTRY_RELATIONSHIP986__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validatePlannedMedicationActivity2EntryRelationship986(PlannedMedicationActivity2 plannedMedicationActivity2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_PLANNED_MEDICATION_ACTIVITY2_ENTRY_RELATIONSHIP986__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.PLANNED_MEDICATION_ACTIVITY2);
			try {
				VALIDATE_PLANNED_MEDICATION_ACTIVITY2_ENTRY_RELATIONSHIP986__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_PLANNED_MEDICATION_ACTIVITY2_ENTRY_RELATIONSHIP986__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_MEDICATION_ACTIVITY2_ENTRY_RELATIONSHIP986__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedMedicationActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.PLANNED_MEDICATION_ACTIVITY2__PLANNED_MEDICATION_ACTIVITY2_ENTRY_RELATIONSHIP986,
						 ConsolPlugin.INSTANCE.getString("PlannedMedicationActivity2PlannedMedicationActivity2EntryRelationship986"),
						 new Object [] { plannedMedicationActivity2 }));
			}
	...
	/**
	 * The cached OCL expression body for the '{@link #validatePlannedMedicationActivity2EntryRelationship988(PlannedMedicationActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Planned Medication Activity2 Entry Relationship988</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePlannedMedicationActivity2EntryRelationship988(PlannedMedicationActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_PLANNED_MEDICATION_ACTIVITY2_ENTRY_RELATIONSHIP988__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entryRelationship->one(entryRelationship : cda::EntryRelationship | not entryRelationship.oclIsUndefined() and entryRelationship.oclIsKindOf(cda::EntryRelationship))";

	/**
	 * The cached OCL invariant for the '{@link #validatePlannedMedicationActivity2EntryRelationship988(PlannedMedicationActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Planned Medication Activity2 Entry Relationship988</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePlannedMedicationActivity2EntryRelationship988(PlannedMedicationActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Constraint VALIDATE_PLANNED_MEDICATION_ACTIVITY2_ENTRY_RELATIONSHIP988__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validatePlannedMedicationActivity2EntryRelationship988(PlannedMedicationActivity2 plannedMedicationActivity2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_PLANNED_MEDICATION_ACTIVITY2_ENTRY_RELATIONSHIP988__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.PLANNED_MEDICATION_ACTIVITY2);
			try {
				VALIDATE_PLANNED_MEDICATION_ACTIVITY2_ENTRY_RELATIONSHIP988__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_PLANNED_MEDICATION_ACTIVITY2_ENTRY_RELATIONSHIP988__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_PLANNED_MEDICATION_ACTIVITY2_ENTRY_RELATIONSHIP988__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedMedicationActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.PLANNED_MEDICATION_ACTIVITY2__PLANNED_MEDICATION_ACTIVITY2_ENTRY_RELATIONSHIP988,
						 ConsolPlugin.INSTANCE.getString("PlannedMedicationActivity2PlannedMedicationActivity2EntryRelationship988"),
						 new Object [] { plannedMedicationActivity2 }));
			}
	...
	/**
	 * The cached OCL expression body for the '{@link #validatePlannedMedicationActivity2PriorityPreferenceEntryRelationshipPriorityPreference985(PlannedMedicationActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Planned Medication Activity2 Priority Preference Entry Relationship Priority Preference985</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePlannedMedicationActivity2PriorityPreferenceEntryRelationshipPriorityPreference985(PlannedMedicationActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The cached OCL invariant for the '{@link #validatePlannedMedicationActivity2PriorityPreferenceEntryRelationshipPriorityPreference985(PlannedMedicationActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Planned Medication Activity2 Priority Preference Entry Relationship Priority Preference985</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePlannedMedicationActivity2PriorityPreferenceEntryRelationshipPriorityPreference985(PlannedMedicationActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Query<?, ?, ?> VALIDATE_PLANNED_MEDICATION_ACTIVITY2_PRIORITY_PREFERENCE_ENTRY_RELATIONSHIP_PRIORITY_PREFERENCE985__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY;
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static  boolean validatePlannedMedicationActivity2PriorityPreferenceEntryRelationshipPriorityPreference985(PlannedMedicationActivity2 plannedMedicationActivity2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_PLANNED_MEDICATION_ACTIVITY2_PRIORITY_PREFERENCE_ENTRY_RELATIONSHIP_PRIORITY_PREFERENCE985__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.PLANNED_MEDICATION_ACTIVITY2);
			try {
				OCLExpression<EClassifier> oclExpression = helper.createQuery(VALIDATE_PLANNED_MEDICATION_ACTIVITY2_PRIORITY_PREFERENCE_ENTRY_RELATIONSHIP_PRIORITY_PREFERENCE985__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
				VALIDATE_PLANNED_MEDICATION_ACTIVITY2_PRIORITY_PREFERENCE_ENTRY_RELATIONSHIP_PRIORITY_PREFERENCE985__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = EOCL_ENV.createQuery(oclExpression);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		Object oclResult = VALIDATE_PLANNED_MEDICATION_ACTIVITY2_PRIORITY_PREFERENCE_ENTRY_RELATIONSHIP_PRIORITY_PREFERENCE985__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY.evaluate(plannedMedicationActivity2);		
		if (oclResult != null && oclResult instanceof Collection) {
			Collection<? extends EObject> oclResultSet = (Collection<? extends EObject>) oclResult;
			...
			if (diagnostics != null) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.PLANNED_MEDICATION_ACTIVITY2__PLANNED_MEDICATION_ACTIVITY2_PRIORITY_PREFERENCE_ENTRY_RELATIONSHIP_PRIORITY_PREFERENCE985,
						 ConsolPlugin.INSTANCE.getString("PlannedMedicationActivity2PlannedMedicationActivity2PriorityPreferenceEntryRelationshipPriorityPreference985"),
						 new Object [] { eObject }));
				}
	...
	/**
	 * The cached OCL expression body for the '{@link #validatePlannedMedicationActivity2Indication2EntryRelationshipIndication2987(PlannedMedicationActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Planned Medication Activity2 Indication2 Entry Relationship Indication2987</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePlannedMedicationActivity2Indication2EntryRelationshipIndication2987(PlannedMedicationActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The cached OCL invariant for the '{@link #validatePlannedMedicationActivity2Indication2EntryRelationshipIndication2987(PlannedMedicationActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Planned Medication Activity2 Indication2 Entry Relationship Indication2987</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePlannedMedicationActivity2Indication2EntryRelationshipIndication2987(PlannedMedicationActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Query<?, ?, ?> VALIDATE_PLANNED_MEDICATION_ACTIVITY2_INDICATION2_ENTRY_RELATIONSHIP_INDICATION2987__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY;
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static  boolean validatePlannedMedicationActivity2Indication2EntryRelationshipIndication2987(PlannedMedicationActivity2 plannedMedicationActivity2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_PLANNED_MEDICATION_ACTIVITY2_INDICATION2_ENTRY_RELATIONSHIP_INDICATION2987__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.PLANNED_MEDICATION_ACTIVITY2);
			try {
				OCLExpression<EClassifier> oclExpression = helper.createQuery(VALIDATE_PLANNED_MEDICATION_ACTIVITY2_INDICATION2_ENTRY_RELATIONSHIP_INDICATION2987__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
				VALIDATE_PLANNED_MEDICATION_ACTIVITY2_INDICATION2_ENTRY_RELATIONSHIP_INDICATION2987__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = EOCL_ENV.createQuery(oclExpression);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		Object oclResult = VALIDATE_PLANNED_MEDICATION_ACTIVITY2_INDICATION2_ENTRY_RELATIONSHIP_INDICATION2987__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY.evaluate(plannedMedicationActivity2);		
		if (oclResult != null && oclResult instanceof Collection) {
			Collection<? extends EObject> oclResultSet = (Collection<? extends EObject>) oclResult;
			...
			if (diagnostics != null) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.PLANNED_MEDICATION_ACTIVITY2__PLANNED_MEDICATION_ACTIVITY2_INDICATION2_ENTRY_RELATIONSHIP_INDICATION2987,
						 ConsolPlugin.INSTANCE.getString("PlannedMedicationActivity2PlannedMedicationActivity2Indication2EntryRelationshipIndication2987"),
						 new Object [] { eObject }));
				}
	...
	/**
	 * The cached OCL expression body for the '{@link #validatePlannedMedicationActivity2Instruction2EntryRelationshipInstruction2989(PlannedMedicationActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Planned Medication Activity2 Instruction2 Entry Relationship Instruction2989</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePlannedMedicationActivity2Instruction2EntryRelationshipInstruction2989(PlannedMedicationActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_PLANNED_MEDICATION_ACTIVITY2_INSTRUCTION2_ENTRY_RELATIONSHIP_INSTRUCTION2989__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entryRelationship->excluding(null)->reject(act->exists(act : cda::Act | not act.oclIsUndefined() and act.oclIsKindOf(consol::Instruction2)))";

	/**
	 * The cached OCL invariant for the '{@link #validatePlannedMedicationActivity2Instruction2EntryRelationshipInstruction2989(PlannedMedicationActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Planned Medication Activity2 Instruction2 Entry Relationship Instruction2989</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePlannedMedicationActivity2Instruction2EntryRelationshipInstruction2989(PlannedMedicationActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Query<?, ?, ?> VALIDATE_PLANNED_MEDICATION_ACTIVITY2_INSTRUCTION2_ENTRY_RELATIONSHIP_INSTRUCTION2989__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY;
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static  boolean validatePlannedMedicationActivity2Instruction2EntryRelationshipInstruction2989(PlannedMedicationActivity2 plannedMedicationActivity2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_PLANNED_MEDICATION_ACTIVITY2_INSTRUCTION2_ENTRY_RELATIONSHIP_INSTRUCTION2989__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.PLANNED_MEDICATION_ACTIVITY2);
			try {
				OCLExpression<EClassifier> oclExpression = helper.createQuery(VALIDATE_PLANNED_MEDICATION_ACTIVITY2_INSTRUCTION2_ENTRY_RELATIONSHIP_INSTRUCTION2989__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
				VALIDATE_PLANNED_MEDICATION_ACTIVITY2_INSTRUCTION2_ENTRY_RELATIONSHIP_INSTRUCTION2989__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = EOCL_ENV.createQuery(oclExpression);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		Object oclResult = VALIDATE_PLANNED_MEDICATION_ACTIVITY2_INSTRUCTION2_ENTRY_RELATIONSHIP_INSTRUCTION2989__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY.evaluate(plannedMedicationActivity2);		
		if (oclResult != null && oclResult instanceof Collection) {
			Collection<? extends EObject> oclResultSet = (Collection<? extends EObject>) oclResult;
			...
			if (diagnostics != null) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.PLANNED_MEDICATION_ACTIVITY2__PLANNED_MEDICATION_ACTIVITY2_INSTRUCTION2_ENTRY_RELATIONSHIP_INSTRUCTION2989,
						 ConsolPlugin.INSTANCE.getString("PlannedMedicationActivity2PlannedMedicationActivity2Instruction2EntryRelationshipInstruction2989"),
						 new Object [] { eObject }));
				}
	...
	public static boolean validatePlanOfCareActivitySubstanceAdministrationTemplateId(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLAN_OF_CARE_ACTIVITY_SUBSTANCE_ADMINISTRATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedMedicationActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
...
"value = vocab::x_DocumentSubstanceMood::INT or value = vocab::x_DocumentSubstanceMood::PRMS or value = vocab::x_DocumentSubstanceMood::PRP or value = vocab::x_DocumentSubstanceMood::RQO";
	...
	public static boolean validatePlanOfCareActivitySubstanceAdministrationMoodCode(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLAN_OF_CARE_ACTIVITY_SUBSTANCE_ADMINISTRATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(plannedMedicationActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
