 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='ResultOrganizerTemplateId ResultOrganizerClassCode ResultOrganizerMoodCode ResultOrganizerId ResultOrganizerStatusCode ResultOrganizerStatusCodeP ResultOrganizerCode ResultOrganizerResultObservationEntryRelationshipResultObservation77' templateId.root='2.16.840.1.113883.10.20.22.4.1' constraints.validation.warning='ResultOrganizerCodeValue ResultOrganizerClassCodeValue' moodCode='EVN' constraints.validation.dependOn.ResultOrganizerStatusCode='ResultOrganizerStatusCodeP' constraints.validation.query='ResultOrganizerResultObservationEntryRelationshipResultObservation77'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/consolResultOrganizerResultObservationEntryRelationship constraints.validation.error='ResultOrganizerResultObservationEntryRelationshipResultObservation77'"
 * @generated
 */
public interface ResultOrganizer extends Organizer {
	...
	* <!-- end-user-doc -->
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.->reject(observation->exists(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(consol::ResultObservation)))'"
	 * @generated
	 */
	boolean validateResultOrganizerResultObservationEntryRelationshipResultObservation77(DiagnosticChain diagnostics, Map<Object, Object> context);
