...
public class EncounterActivity2Operations extends EncounterActivitiesOperations {
	...
	public static boolean validateEncounterActivitiesCodeP(EncounterActivity2 encounterActivity2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ENCOUNTER_ACTIVITIES_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(encounterActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  boolean validateEncounterActivity2EntryRelationship904(EncounterActivity2 encounterActivity2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_ENCOUNTER_ACTIVITY2_ENTRY_RELATIONSHIP904__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.ENCOUNTER_ACTIVITY2);
			try {
				VALIDATE_ENCOUNTER_ACTIVITY2_ENTRY_RELATIONSHIP904__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_ENCOUNTER_ACTIVITY2_ENTRY_RELATIONSHIP904__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_ENCOUNTER_ACTIVITY2_ENTRY_RELATIONSHIP904__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(encounterActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.ENCOUNTER_ACTIVITY2__ENCOUNTER_ACTIVITY2_ENTRY_RELATIONSHIP904,
						 ConsolPlugin.INSTANCE.getString("EncounterActivity2EncounterActivity2EntryRelationship904"),
						 new Object [] { encounterActivity2 }));
			}
	...
	public static  boolean validateEncounterActivity2EntryRelationship906(EncounterActivity2 encounterActivity2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_ENCOUNTER_ACTIVITY2_ENTRY_RELATIONSHIP906__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.ENCOUNTER_ACTIVITY2);
			try {
				VALIDATE_ENCOUNTER_ACTIVITY2_ENTRY_RELATIONSHIP906__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_ENCOUNTER_ACTIVITY2_ENTRY_RELATIONSHIP906__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_ENCOUNTER_ACTIVITY2_ENTRY_RELATIONSHIP906__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(encounterActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.ENCOUNTER_ACTIVITY2__ENCOUNTER_ACTIVITY2_ENTRY_RELATIONSHIP906,
						 ConsolPlugin.INSTANCE.getString("EncounterActivity2EncounterActivity2EntryRelationship906"),
						 new Object [] { encounterActivity2 }));
			}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static  boolean validateEncounterActivity2Indication2EntryRelationshipIndication2905(EncounterActivity2 encounterActivity2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_ENCOUNTER_ACTIVITY2_INDICATION2_ENTRY_RELATIONSHIP_INDICATION2905__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.ENCOUNTER_ACTIVITY2);
			try {
				OCLExpression<EClassifier> oclExpression = helper.createQuery(VALIDATE_ENCOUNTER_ACTIVITY2_INDICATION2_ENTRY_RELATIONSHIP_INDICATION2905__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
				VALIDATE_ENCOUNTER_ACTIVITY2_INDICATION2_ENTRY_RELATIONSHIP_INDICATION2905__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = EOCL_ENV.createQuery(oclExpression);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		Object oclResult = VALIDATE_ENCOUNTER_ACTIVITY2_INDICATION2_ENTRY_RELATIONSHIP_INDICATION2905__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY.evaluate(encounterActivity2);		
		if (oclResult != null && oclResult instanceof Collection) {
			Collection<? extends EObject> oclResultSet = (Collection<? extends EObject>) oclResult;
			...
			if (diagnostics != null) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.ENCOUNTER_ACTIVITY2__ENCOUNTER_ACTIVITY2_INDICATION2_ENTRY_RELATIONSHIP_INDICATION2905,
						 ConsolPlugin.INSTANCE.getString("EncounterActivity2EncounterActivity2Indication2EntryRelationshipIndication2905"),
						 new Object [] { eObject }));
				}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static  boolean validateEncounterActivity2EncounterDiagnosis2EntryRelationshipEncounterDiagnosis2907(EncounterActivity2 encounterActivity2, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_ENCOUNTER_ACTIVITY2_ENCOUNTER_DIAGNOSIS2_ENTRY_RELATIONSHIP_ENCOUNTER_DIAGNOSIS2907__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.ENCOUNTER_ACTIVITY2);
			try {
				OCLExpression<EClassifier> oclExpression = helper.createQuery(VALIDATE_ENCOUNTER_ACTIVITY2_ENCOUNTER_DIAGNOSIS2_ENTRY_RELATIONSHIP_ENCOUNTER_DIAGNOSIS2907__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
				VALIDATE_ENCOUNTER_ACTIVITY2_ENCOUNTER_DIAGNOSIS2_ENTRY_RELATIONSHIP_ENCOUNTER_DIAGNOSIS2907__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = EOCL_ENV.createQuery(oclExpression);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		Object oclResult = VALIDATE_ENCOUNTER_ACTIVITY2_ENCOUNTER_DIAGNOSIS2_ENTRY_RELATIONSHIP_ENCOUNTER_DIAGNOSIS2907__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY.evaluate(encounterActivity2);		
		if (oclResult != null && oclResult instanceof Collection) {
			Collection<? extends EObject> oclResultSet = (Collection<? extends EObject>) oclResult;
			...
			if (diagnostics != null) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.ENCOUNTER_ACTIVITY2__ENCOUNTER_ACTIVITY2_ENCOUNTER_DIAGNOSIS2_ENTRY_RELATIONSHIP_ENCOUNTER_DIAGNOSIS2907,
						 ConsolPlugin.INSTANCE.getString("EncounterActivity2EncounterActivity2EncounterDiagnosis2EntryRelationshipEncounterDiagnosis2907"),
						 new Object [] { eObject }));
				}
	...
	public static boolean validateEncounterActivitiesSdtcDDCFromNUBCOrDD(EncounterActivity2 encounterActivity2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ENCOUNTER_ACTIVITIES_SDTC_DDC_FROM_NUBC_OR_DD__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(encounterActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateEncounterActivitiesTemplateId(EncounterActivity2 encounterActivity2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ENCOUNTER_ACTIVITIES_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(encounterActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	/**
	 * The cached OCL expression body for the '{@link #validateEncounterActivity2EntryRelationship904(EncounterActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Encounter Activity2 Entry Relationship904</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateEncounterActivity2EntryRelationship904(EncounterActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_ENCOUNTER_ACTIVITY2_ENTRY_RELATIONSHIP904__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entryRelationship->one(entryRelationship : cda::EntryRelationship | not entryRelationship.oclIsUndefined() and entryRelationship.oclIsKindOf(cda::EntryRelationship))";

	/**
	 * The cached OCL invariant for the '{@link #validateEncounterActivity2EntryRelationship904(EncounterActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Encounter Activity2 Entry Relationship904</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateEncounterActivity2EntryRelationship904(EncounterActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Constraint VALIDATE_ENCOUNTER_ACTIVITY2_ENTRY_RELATIONSHIP904__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;

	/**
	 * The cached OCL expression body for the '{@link #validateEncounterActivity2EntryRelationship906(EncounterActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Encounter Activity2 Entry Relationship906</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateEncounterActivity2EntryRelationship906(EncounterActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_ENCOUNTER_ACTIVITY2_ENTRY_RELATIONSHIP906__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entryRelationship->one(entryRelationship : cda::EntryRelationship | not entryRelationship.oclIsUndefined() and entryRelationship.oclIsKindOf(cda::EntryRelationship))";

	/**
	 * The cached OCL invariant for the '{@link #validateEncounterActivity2EntryRelationship906(EncounterActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Encounter Activity2 Entry Relationship906</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateEncounterActivity2EntryRelationship906(EncounterActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Constraint VALIDATE_ENCOUNTER_ACTIVITY2_ENTRY_RELATIONSHIP906__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	/**
	 * The cached OCL expression body for the '{@link #validateEncounterActivity2Indication2EntryRelationshipIndication2905(EncounterActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Encounter Activity2 Indication2 Entry Relationship Indication2905</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateEncounterActivity2Indication2EntryRelationshipIndication2905(EncounterActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The cached OCL invariant for the '{@link #validateEncounterActivity2Indication2EntryRelationshipIndication2905(EncounterActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Encounter Activity2 Indication2 Entry Relationship Indication2905</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateEncounterActivity2Indication2EntryRelationshipIndication2905(EncounterActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Query<?, ?, ?> VALIDATE_ENCOUNTER_ACTIVITY2_INDICATION2_ENTRY_RELATIONSHIP_INDICATION2905__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY;

	/**
	 * The cached OCL expression body for the '{@link #validateEncounterActivity2EncounterDiagnosis2EntryRelationshipEncounterDiagnosis2907(EncounterActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Encounter Activity2 Encounter Diagnosis2 Entry Relationship Encounter Diagnosis2907</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateEncounterActivity2EncounterDiagnosis2EntryRelationshipEncounterDiagnosis2907(EncounterActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_ENCOUNTER_ACTIVITY2_ENCOUNTER_DIAGNOSIS2_ENTRY_RELATIONSHIP_ENCOUNTER_DIAGNOSIS2907__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entryRelationship->excluding(null)->reject(act->exists(act : cda::Act | not act.oclIsUndefined() and act.oclIsKindOf(consol::EncounterDiagnosis2)))";

	/**
	 * The cached OCL invariant for the '{@link #validateEncounterActivity2EncounterDiagnosis2EntryRelationshipEncounterDiagnosis2907(EncounterActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Encounter Activity2 Encounter Diagnosis2 Entry Relationship Encounter Diagnosis2907</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateEncounterActivity2EncounterDiagnosis2EntryRelationshipEncounterDiagnosis2907(EncounterActivity2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Query<?, ?, ?> VALIDATE_ENCOUNTER_ACTIVITY2_ENCOUNTER_DIAGNOSIS2_ENTRY_RELATIONSHIP_ENCOUNTER_DIAGNOSIS2907__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY;
...
"value.codeSystem = '2.16.840.1.113883.6.12' and not value.code.oclIsUndefined())";
	...
	public static boolean validateEncounterActivitiesCode(EncounterActivity2 encounterActivity2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ENCOUNTER_ACTIVITIES_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(encounterActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
	...
	public static boolean validateEncounterActivitiesSDTCDischargeDispositionCode(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ENCOUNTER_ACTIVITIES_SDTC_DISCHARGE_DISPOSITION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(encounterActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
	...
	public static boolean validateEncounterActivitiesServiceDeliveryLocation(EncounterActivity2 encounterActivity2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ENCOUNTER_ACTIVITIES_SERVICE_DELIVERY_LOCATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(encounterActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
	...
	public static boolean validateEncounterActivitiesEncounterPerformer(EncounterActivity2 encounterActivity2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ENCOUNTER_ACTIVITIES_ENCOUNTER_PERFORMER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(encounterActivity2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
