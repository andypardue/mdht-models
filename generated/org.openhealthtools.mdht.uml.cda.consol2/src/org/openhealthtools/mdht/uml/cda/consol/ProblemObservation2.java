 ...
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/consolProblemObservation2PrognosisObservationEntryRelationship constraints.validation.info='ProblemObservation2PrognosisObservationEntryRelationshipPrognosisObservation1007'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/consolProblemObservation2PriorityPreferenceEntryRelationship constraints.validation.info='ProblemObservation2PriorityPreferenceEntryRelationshipPriorityPreference1009'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/consolProblemObservation2ProblemStatusEntryRelationship constraints.validation.info='ProblemObservation2ProblemStatusEntryRelationshipProblemStatus1011'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/consolProblemObservation2HealthStatusObservationEntryRelationship constraints.validation.error='ProblemObservation2HealthStatusObservationEntryRelationshipHealthStatusObservation1013'"
 * @generated
 */
public interface ProblemObservation2 extends ProblemObservation {
	 ...
	 * @generated
	 */
	boolean validateProblemObservation2EntryRelationship1006(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @generated
	 */
	boolean validateProblemObservation2EntryRelationship1008(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @generated
	 */
	boolean validateProblemObservation2EntryRelationship1010(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @generated
	 */
	boolean validateProblemObservation2EntryRelationship1012(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.entryRelationship->excluding(null)->reject(observation->one(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(consol::PrognosisObservation)))'"
	 * @generated
	 */
	boolean validateProblemObservation2PrognosisObservationEntryRelationshipPrognosisObservation1007(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @generated
	 */
	boolean validateProblemObservation2PriorityPreferenceEntryRelationshipPriorityPreference1009(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.entryRelationship->excluding(null)->reject(observation->one(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(consol::ProblemStatus)))'"
	 * @generated
	 */
	boolean validateProblemObservation2ProblemStatusEntryRelationshipProblemStatus1011(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.entryRelationship->excluding(null)->reject(observation->one(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(consol::HealthStatusObservation)))'"
	 * @generated
	 */
	boolean validateProblemObservation2HealthStatusObservationEntryRelationshipHealthStatusObservation1013(DiagnosticChain diagnostics, Map<Object, Object> context);
