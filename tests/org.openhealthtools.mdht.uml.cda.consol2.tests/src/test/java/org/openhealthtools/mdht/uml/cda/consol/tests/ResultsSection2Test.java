...
public class ResultsSection2Test extends CDAValidationTest {
	...
	*/
	...
	public void testValidateResultsSection2Entry1210() {
		OperationsTestCase<ResultsSection2> validateResultsSection2Entry1210TestCase = new OperationsTestCase<ResultsSection2>(
			"validateResultsSection2Entry1210",
			operationsForOCL.getOCLValue("VALIDATE_RESULTS_SECTION2_ENTRY1210__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"),
			objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return ResultsSection2Operations.validateResultsSection2Entry1210(
					(ResultsSection2) objectToTest, diagnostician, map);
			}

		};

		validateResultsSection2Entry1210TestCase.doValidationTest();
	}
	...
	*/
	...
	public void testValidateResultsSection2ResultOrganizer2EntryResultOrganizer21211() {
		OperationsTestCase<ResultsSection2> validateResultsSection2ResultOrganizer2EntryResultOrganizer21211TestCase = new OperationsTestCase<ResultsSection2>(
			"validateResultsSection2ResultOrganizer2EntryResultOrganizer21211",
			operationsForOCL.getOCLValue(
				"VALIDATE_RESULTS_SECTION2_RESULT_ORGANIZER2_ENTRY_RESULT_ORGANIZER21211__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"),
			objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return ResultsSection2Operations.validateResultsSection2ResultOrganizer2EntryResultOrganizer21211(
					(ResultsSection2) objectToTest, diagnostician, map);
			}

		};

		validateResultsSection2ResultOrganizer2EntryResultOrganizer21211TestCase.doValidationTest();
	}
