...
public class CoverageActivity2Test extends CDAValidationTest {
	...
	*/
	...
	public void testValidateCoverageActivity2EntryRelationship898() {
		OperationsTestCase<CoverageActivity2> validateCoverageActivity2EntryRelationship898TestCase = new OperationsTestCase<CoverageActivity2>(
			"validateCoverageActivity2EntryRelationship898", operationsForOCL.getOCLValue(
				"VALIDATE_COVERAGE_ACTIVITY2_ENTRY_RELATIONSHIP898__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"),
			objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return CoverageActivity2Operations.validateCoverageActivity2EntryRelationship898(
					(CoverageActivity2) objectToTest, diagnostician, map);
			}

		};

		validateCoverageActivity2EntryRelationship898TestCase.doValidationTest();
	}
	...
	*/
	...
	public void testValidateCoverageActivity2PolicyActivity2EntryRelationshipPolicyActivity2899() {
		OperationsTestCase<CoverageActivity2> validateCoverageActivity2PolicyActivity2EntryRelationshipPolicyActivity2899TestCase = new OperationsTestCase<CoverageActivity2>(
			"validateCoverageActivity2PolicyActivity2EntryRelationshipPolicyActivity2899",
			operationsForOCL.getOCLValue(
				"VALIDATE_COVERAGE_ACTIVITY2_POLICY_ACTIVITY2_ENTRY_RELATIONSHIP_POLICY_ACTIVITY2899__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"),
			objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return CoverageActivity2Operations.validateCoverageActivity2PolicyActivity2EntryRelationshipPolicyActivity2899(
					(CoverageActivity2) objectToTest, diagnostician, map);
			}

		};

		validateCoverageActivity2PolicyActivity2EntryRelationshipPolicyActivity2899TestCase.doValidationTest();
	}
