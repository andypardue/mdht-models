...
public class FamilyHistoryOrganizerTest extends CDAValidationTest {
	...
	*/
	...
	public void testValidateFamilyHistoryOrganizerFamilyHistoryObservationEntryRelationshipFamilyHistoryObservation61() {
		OperationsTestCase<FamilyHistoryOrganizer> validateFamilyHistoryOrganizerFamilyHistoryObservationEntryRelationshipFamilyHistoryObservation61TestCase = new OperationsTestCase<FamilyHistoryOrganizer>(
			"validateFamilyHistoryOrganizerFamilyHistoryObservationEntryRelationshipFamilyHistoryObservation61",
			operationsForOCL.getOCLValue(
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return FamilyHistoryOrganizerOperations.validateFamilyHistoryOrganizerFamilyHistoryObservationEntryRelationshipFamilyHistoryObservation61(
					(FamilyHistoryOrganizer) objectToTest, diagnostician, map);
			}

		};

		validateFamilyHistoryOrganizerFamilyHistoryObservationEntryRelationshipFamilyHistoryObservation61TestCase.doValidationTest();
	}
